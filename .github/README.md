...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.433.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.433.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Usd4qdWC8BUvXznd7usAle8laJAq8lhQ1R8lo3ZL4wXNi3WMvbhtfHtcxK+iePvM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.433.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.433.0/index.min.mjs": "sha384-Usd4qdWC8BUvXznd7usAle8laJAq8lhQ1R8lo3ZL4wXNi3WMvbhtfHtcxK+iePvM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.433.0/LICENSE
```

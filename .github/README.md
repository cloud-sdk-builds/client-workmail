...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YNUuseGyR/opztPFki7vNTOsdd4Ijv3B839sSVHbtAscLjWAFMf8pPtDGeV/UrDf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.666.0/index.min.mjs": "sha384-YNUuseGyR/opztPFki7vNTOsdd4Ijv3B839sSVHbtAscLjWAFMf8pPtDGeV/UrDf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.666.0/LICENSE
```

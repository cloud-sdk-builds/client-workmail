...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kAYjkeaQph6TbSZ8VqE3uyqlpPmQZjPRdt6uY4/rCSa8zELOHKF3hF7cysl+ecj5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.353.0/index.min.mjs": "sha384-kAYjkeaQph6TbSZ8VqE3uyqlpPmQZjPRdt6uY4/rCSa8zELOHKF3hF7cysl+ecj5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.353.0/LICENSE
```

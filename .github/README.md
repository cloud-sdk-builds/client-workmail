...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3pV+tXVyOIL25Rps1O1aZiADcCJ8WY0UQBOjAVRnL12y/Ok3+6A+GGMrdCK0sjVo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.925.0/index.min.mjs": "sha384-3pV+tXVyOIL25Rps1O1aZiADcCJ8WY0UQBOjAVRnL12y/Ok3+6A+GGMrdCK0sjVo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.925.0/LICENSE
```

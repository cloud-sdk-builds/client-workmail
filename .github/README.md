...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zplQBDOrG4XhjVSmA/tSQZM+O+hp5tySPCF5upHW/iMQEgiql0qY3+03hir1wzFj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.264.0/index.min.mjs": "sha384-zplQBDOrG4XhjVSmA/tSQZM+O+hp5tySPCF5upHW/iMQEgiql0qY3+03hir1wzFj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.264.0/LICENSE
```

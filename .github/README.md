...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zRfH0tHyBicEs74j+W3q4TGagNvaSRXnvnYHJsNbnXYoYHrT9y94HxLdbZW/hLq9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.876.0/index.min.mjs": "sha384-zRfH0tHyBicEs74j+W3q4TGagNvaSRXnvnYHJsNbnXYoYHrT9y94HxLdbZW/hLq9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.876.0/LICENSE
```

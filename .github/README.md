...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kb7yHZ9VHuYKvBfOa118galtL7svKXKt7Bp2sgLuTY/h22RgWuRq7csPShYVHiuu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.489.0/index.min.mjs": "sha384-kb7yHZ9VHuYKvBfOa118galtL7svKXKt7Bp2sgLuTY/h22RgWuRq7csPShYVHiuu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.489.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.473.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.473.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nS2fCwZ5xkDrMeaDIbCm6zUbUdrDDbdAvQAo0ApxEqQ5UK3+O1a7d/ln7ISSI8ir
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.473.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.473.0/index.min.mjs": "sha384-nS2fCwZ5xkDrMeaDIbCm6zUbUdrDDbdAvQAo0ApxEqQ5UK3+O1a7d/ln7ISSI8ir"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.473.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.430.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.430.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+stBCgYObfacv5j2yTL6KSiiuM9jDZkV2JDHKU97psMMjg9O3HYto/ULAwlA5o4/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.430.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.430.0/index.min.mjs": "sha384-+stBCgYObfacv5j2yTL6KSiiuM9jDZkV2JDHKU97psMMjg9O3HYto/ULAwlA5o4/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.430.0/LICENSE
```

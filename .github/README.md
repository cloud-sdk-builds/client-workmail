...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-veiW2kPld9rsR8rV1eI0qiSfWqq/NAfB63v35KsFFETp+ylT6P9Q3IfX0Izpfo3d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.645.0/index.min.mjs": "sha384-veiW2kPld9rsR8rV1eI0qiSfWqq/NAfB63v35KsFFETp+ylT6P9Q3IfX0Izpfo3d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.645.0/LICENSE
```

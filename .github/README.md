...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-txcwyRhaidKs/Jukfu9oyr9h0M6dQfmvkIV0FrT/cFmOoSfn9UetvPrAXDN0r8uw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.758.0/index.min.mjs": "sha384-txcwyRhaidKs/Jukfu9oyr9h0M6dQfmvkIV0FrT/cFmOoSfn9UetvPrAXDN0r8uw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.758.0/LICENSE
```

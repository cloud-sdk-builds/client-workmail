...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+omM32Mn2IDjKUKjfOgDQ6degeU48MK5FjkHSPi9uK+zXeomCE57o/ccX5U6qkMw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.410.0/index.min.mjs": "sha384-+omM32Mn2IDjKUKjfOgDQ6degeU48MK5FjkHSPi9uK+zXeomCE57o/ccX5U6qkMw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.410.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.52.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.52.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BwC1cI81wd8WBHPv1xe8mPuZzg53YOZtcWX00Uwq8gAKfdkSFWWF1kaPC3AZhSyX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.52.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.52.0/index.min.mjs": "sha384-BwC1cI81wd8WBHPv1xe8mPuZzg53YOZtcWX00Uwq8gAKfdkSFWWF1kaPC3AZhSyX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.52.0/LICENSE
```

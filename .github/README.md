...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lmVEwRnhdIt/sn4sEMKLrbEdbvMpUhMcTXrJL5PuPB4N1EUFCabcHkBd0+JnNT/H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.991.0/index.min.mjs": "sha384-lmVEwRnhdIt/sn4sEMKLrbEdbvMpUhMcTXrJL5PuPB4N1EUFCabcHkBd0+JnNT/H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.991.0/LICENSE
```

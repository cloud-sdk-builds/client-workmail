...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tKXl/Rr5nJL1okrXQTtt1c2SP4SRgHVh95/F3Fp+h5ViIrdYKI1Cs1HBRziK4+pD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.609.0/index.min.mjs": "sha384-tKXl/Rr5nJL1okrXQTtt1c2SP4SRgHVh95/F3Fp+h5ViIrdYKI1Cs1HBRziK4+pD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.609.0/LICENSE
```

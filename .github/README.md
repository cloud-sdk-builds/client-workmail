...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MQKQXKj1tOmCRdSad4pV4UAsPLJlqc0QrRvJRT1orkmjFYOhVxz9jjfccfb39ySE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.825.0/index.min.mjs": "sha384-MQKQXKj1tOmCRdSad4pV4UAsPLJlqc0QrRvJRT1orkmjFYOhVxz9jjfccfb39ySE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.825.0/LICENSE
```

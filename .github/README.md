...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dBe4hhkcDcJutFBg1HJ966cUEzeW8b7ZFWDK1Q+lIHBH7gzQKxDKtu4+A86/xK1D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.382.0/index.min.mjs": "sha384-dBe4hhkcDcJutFBg1HJ966cUEzeW8b7ZFWDK1Q+lIHBH7gzQKxDKtu4+A86/xK1D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.382.0/LICENSE
```

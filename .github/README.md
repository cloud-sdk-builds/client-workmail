...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1000.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1000.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yHD5ihU1RuQnAb82ZveByg7m+uhTZBp47nnA4eVHBZeQlUTqbZe7QZM7y3cFnQ83
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1000.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1000.0/index.min.mjs": "sha384-yHD5ihU1RuQnAb82ZveByg7m+uhTZBp47nnA4eVHBZeQlUTqbZe7QZM7y3cFnQ83"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1000.0/LICENSE
```

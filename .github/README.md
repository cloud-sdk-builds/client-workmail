...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CZdT0kboV2NOZ63fubgK0IG6qUyB33xukgg76u7qAZFV2+4VpTlorzluuRlkAeaq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.920.0/index.min.mjs": "sha384-CZdT0kboV2NOZ63fubgK0IG6qUyB33xukgg76u7qAZFV2+4VpTlorzluuRlkAeaq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.920.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bSKQ9Sr1mIWw+jF30L3U1Y/tPezcu7ST2fdDCV5/kHpa3AsnTsQSEoKT/+91BfPP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.835.0/index.min.mjs": "sha384-bSKQ9Sr1mIWw+jF30L3U1Y/tPezcu7ST2fdDCV5/kHpa3AsnTsQSEoKT/+91BfPP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.835.0/LICENSE
```

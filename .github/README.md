...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.377.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.377.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-glKBjjxW3AE9EHL9Cw0AkqNAyWqwZXdN0CIaJO9PI2FRixtUSjaFerRfiiu90EOi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.377.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.377.0/index.min.mjs": "sha384-glKBjjxW3AE9EHL9Cw0AkqNAyWqwZXdN0CIaJO9PI2FRixtUSjaFerRfiiu90EOi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.377.0/LICENSE
```

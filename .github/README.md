...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.352.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.352.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lir4jLZgzgBcwOwKegfVF6x+fMlFt+A1XeEO3xkIfsP7tNMX4S/nFbG7hL2vHluR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.352.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.352.0/index.min.mjs": "sha384-lir4jLZgzgBcwOwKegfVF6x+fMlFt+A1XeEO3xkIfsP7tNMX4S/nFbG7hL2vHluR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.352.0/LICENSE
```

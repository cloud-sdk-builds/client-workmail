...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NDPeIR3tHt/RIdud2HT79B9orMh/xWzyfDMoN/sOXryyNCtpdh5OUc+1rtDe19Ay
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.590.0/index.min.mjs": "sha384-NDPeIR3tHt/RIdud2HT79B9orMh/xWzyfDMoN/sOXryyNCtpdh5OUc+1rtDe19Ay"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.590.0/LICENSE
```

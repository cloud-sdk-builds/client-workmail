...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qWXDJtli3FEXrA9xKYv/eD+EDaMXlzDEYZoWfXP5+owXdglyyFfVtnJ1dtybv78q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.425.0/index.min.mjs": "sha384-qWXDJtli3FEXrA9xKYv/eD+EDaMXlzDEYZoWfXP5+owXdglyyFfVtnJ1dtybv78q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.425.0/LICENSE
```

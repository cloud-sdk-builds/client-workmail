...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u/gC6R9i4v80nsnBq17LAbepzCLAklwzub+0PVJaKTpFwB9XjmP+wfMNuhSj4Pb1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.917.0/index.min.mjs": "sha384-u/gC6R9i4v80nsnBq17LAbepzCLAklwzub+0PVJaKTpFwB9XjmP+wfMNuhSj4Pb1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.917.0/LICENSE
```

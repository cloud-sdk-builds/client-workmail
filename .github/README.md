...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.616.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.616.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WsC7SgfjIbXr8eq0eWpvgh6BHvKzQXzuv+/xvY91wFK9vIQf5pEzx7kcZGGZK91j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.616.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.616.0/index.min.mjs": "sha384-WsC7SgfjIbXr8eq0eWpvgh6BHvKzQXzuv+/xvY91wFK9vIQf5pEzx7kcZGGZK91j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.616.0/LICENSE
```

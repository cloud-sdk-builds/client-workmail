...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3dP6eLY80uLonq1/oTi04l8OKG+ilI8RYNULsYNYP9yvxpd/YbwPUp+FqC6Txg2J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.378.0/index.min.mjs": "sha384-3dP6eLY80uLonq1/oTi04l8OKG+ilI8RYNULsYNYP9yvxpd/YbwPUp+FqC6Txg2J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.378.0/LICENSE
```

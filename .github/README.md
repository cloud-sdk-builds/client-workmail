...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.76.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.76.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LBDJsRE+jCV1e3SYb6+8KY7kiZ30LiadKmDk39numDz9E8ZKOYEwRDFPLQGI8oKK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.76.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.76.0/index.min.mjs": "sha384-LBDJsRE+jCV1e3SYb6+8KY7kiZ30LiadKmDk39numDz9E8ZKOYEwRDFPLQGI8oKK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.76.0/LICENSE
```

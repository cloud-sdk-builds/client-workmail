...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SSknhDECuUsxbAW/62JeekVYOiw1ZiJFLFvnubQhSBJdRr+ppRcYeV4paL3lb0Vi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.359.0/index.min.mjs": "sha384-SSknhDECuUsxbAW/62JeekVYOiw1ZiJFLFvnubQhSBJdRr+ppRcYeV4paL3lb0Vi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.359.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.360.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.360.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SYznyhrXjv6tqpkOV4OOQEzSq3+SCs1zIb6NM1wKXSrCFqi5GIG40YscyiCMC1EB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.360.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.360.0/index.min.mjs": "sha384-SYznyhrXjv6tqpkOV4OOQEzSq3+SCs1zIb6NM1wKXSrCFqi5GIG40YscyiCMC1EB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.360.0/LICENSE
```

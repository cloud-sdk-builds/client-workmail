...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jm2Hjlc2eSLdZXIj7q5ddqJ47fxb1zzd+RsD1wZAdwwPN4ffVx4fRIW/aBTJp49C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.428.0/index.min.mjs": "sha384-jm2Hjlc2eSLdZXIj7q5ddqJ47fxb1zzd+RsD1wZAdwwPN4ffVx4fRIW/aBTJp49C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.428.0/LICENSE
```

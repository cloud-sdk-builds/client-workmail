...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1t7K8HzG1ErDFg4qTE5XB8zSQSMLmBmuMImMSSeC0HGQlZLtuXXXfdOeVRRyPRmu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.926.0/index.min.mjs": "sha384-1t7K8HzG1ErDFg4qTE5XB8zSQSMLmBmuMImMSSeC0HGQlZLtuXXXfdOeVRRyPRmu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.926.0/LICENSE
```

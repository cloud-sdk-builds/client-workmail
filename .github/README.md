...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N6D7lySMYHkOTS0K35bq1yhiFt/SNA/wlXgrQtnO+LL6/rbaV5CwROAA0ECyE5l7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.112.0/index.min.mjs": "sha384-N6D7lySMYHkOTS0K35bq1yhiFt/SNA/wlXgrQtnO+LL6/rbaV5CwROAA0ECyE5l7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.112.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.429.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.429.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2z6eFMb6LV8UCfuM/Kn9FdGV0mOmy/enlMcbEgS8ROw5tgq+dqlVPLVdP4maOyDl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.429.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.429.0/index.min.mjs": "sha384-2z6eFMb6LV8UCfuM/Kn9FdGV0mOmy/enlMcbEgS8ROw5tgq+dqlVPLVdP4maOyDl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.429.0/LICENSE
```

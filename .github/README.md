...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-Auamu29dyznWJGHL0geEjOknJV8Uhe6QtKNqWC2IBoknXFuMUAwd6YZFIdumfvSc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.47.2/index.min.mjs": "sha384-Auamu29dyznWJGHL0geEjOknJV8Uhe6QtKNqWC2IBoknXFuMUAwd6YZFIdumfvSc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.47.2/LICENSE
```

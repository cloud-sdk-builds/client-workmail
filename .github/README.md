...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.4.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.4.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-syCUSAeOcF+xpcn/2tI6YAlFqBd+WXS3F66x63ul5wJwTLt5baV7ToOpWNy6ZG3n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.4.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.4.1/index.min.mjs": "sha384-syCUSAeOcF+xpcn/2tI6YAlFqBd+WXS3F66x63ul5wJwTLt5baV7ToOpWNy6ZG3n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.4.1/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QcMGVFYEAV3+9MSW8M97Sef7bIJI70S4SxW8aM+a+tlMBjVxcIkQpub9fmrDIlf8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.721.0/index.min.mjs": "sha384-QcMGVFYEAV3+9MSW8M97Sef7bIJI70S4SxW8aM+a+tlMBjVxcIkQpub9fmrDIlf8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.721.0/LICENSE
```

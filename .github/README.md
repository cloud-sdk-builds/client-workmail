...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hb+Nj1pO4J+/EGIEO6EEVLDvtb32JbrvVLh2ReSdEvhOrKx4X7q4BNoZwPKDqV6W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.529.1/index.min.mjs": "sha384-Hb+Nj1pO4J+/EGIEO6EEVLDvtb32JbrvVLh2ReSdEvhOrKx4X7q4BNoZwPKDqV6W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.529.1/LICENSE
```

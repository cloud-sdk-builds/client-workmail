...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-orSVa43hzq2yS+7dNXwk3oeTDmwRMlQc6CE4Ki7TmIRiU/L5cOqpA9d8za2wFYMG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.496.0/index.min.mjs": "sha384-orSVa43hzq2yS+7dNXwk3oeTDmwRMlQc6CE4Ki7TmIRiU/L5cOqpA9d8za2wFYMG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.496.0/LICENSE
```

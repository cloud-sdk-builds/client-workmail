...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k+9JdFtLUwDciYbmi5r3OJiiLOD3FN99mf0jKA9KFQ1dnkoIM5FXd8RIQIVmuAZl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.223.0/index.min.mjs": "sha384-k+9JdFtLUwDciYbmi5r3OJiiLOD3FN99mf0jKA9KFQ1dnkoIM5FXd8RIQIVmuAZl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.223.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ajnj8/GFQMEfIWdOy96KFEDgegiLL7WWai2vjwbFsUUCfAm9SQRLYYJjDPc93KMW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.992.0/index.min.mjs": "sha384-ajnj8/GFQMEfIWdOy96KFEDgegiLL7WWai2vjwbFsUUCfAm9SQRLYYJjDPc93KMW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.992.0/LICENSE
```

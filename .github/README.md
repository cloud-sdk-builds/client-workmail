...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.817.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.817.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sDumb3247Oe58Rgtcz8xGSETLNLhoOcjh2BJ7jVG0fm5raAgWehtfRhoEAfI21fs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.817.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.817.0/index.min.mjs": "sha384-sDumb3247Oe58Rgtcz8xGSETLNLhoOcjh2BJ7jVG0fm5raAgWehtfRhoEAfI21fs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.817.0/LICENSE
```

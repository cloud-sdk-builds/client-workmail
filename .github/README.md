...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1002.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1002.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3uLP6o5O7Owft/Wq8AtX+RmyKRclkH8VFfOezho3tx4RNrICaxERxca2Vl8YjJSW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1002.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1002.0/index.min.mjs": "sha384-3uLP6o5O7Owft/Wq8AtX+RmyKRclkH8VFfOezho3tx4RNrICaxERxca2Vl8YjJSW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1002.0/LICENSE
```

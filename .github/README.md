...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SN6IiI5AUhqt4HxlXQDp755kvv58epd/WrZ6G7ZCbEFsAdH7BOwosEpPR/2yrzyW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.908.0/index.min.mjs": "sha384-SN6IiI5AUhqt4HxlXQDp755kvv58epd/WrZ6G7ZCbEFsAdH7BOwosEpPR/2yrzyW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.908.0/LICENSE
```

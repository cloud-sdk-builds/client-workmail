...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mzzgwOFvQJTodAlpm8Uo1ES+vchxeh7XwkYIPZ/Wmo3t20lBmL8CKVNz+IBwmW2F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.2.0/index.min.mjs": "sha384-mzzgwOFvQJTodAlpm8Uo1ES+vchxeh7XwkYIPZ/Wmo3t20lBmL8CKVNz+IBwmW2F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.2.0/LICENSE
```

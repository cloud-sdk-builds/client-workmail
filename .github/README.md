...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AuciVQHoc12r/AxE7RVoHeY9JaTgQuv8KQ1xCcWfJR7rxZxuCX7t8BWvzVcvhJrr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.49.0/index.min.mjs": "sha384-AuciVQHoc12r/AxE7RVoHeY9JaTgQuv8KQ1xCcWfJR7rxZxuCX7t8BWvzVcvhJrr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.49.0/LICENSE
```

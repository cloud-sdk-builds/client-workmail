...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JfhzgujvNH+JkhMyKz3igViqaQX8l3jOSCCMQEWKZbbgffrQuzngfRe4ju0NOxrA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.387.0/index.min.mjs": "sha384-JfhzgujvNH+JkhMyKz3igViqaQX8l3jOSCCMQEWKZbbgffrQuzngfRe4ju0NOxrA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.387.0/LICENSE
```

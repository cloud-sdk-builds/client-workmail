...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.5.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.5.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LKHsuR8k1ZpkigykdMy9w6AXN1A/Ff4SYwu4awGlk3utUKahPRSFPd+2NbShnoag
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.5.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.5.0/index.min.mjs": "sha384-LKHsuR8k1ZpkigykdMy9w6AXN1A/Ff4SYwu4awGlk3utUKahPRSFPd+2NbShnoag"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.5.0/LICENSE
```

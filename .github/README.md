...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GMKhlY6fghJOKdMyYRajfHFGRSQl9ybJkYvlIBnN3y+BPo/aJS+d8mQdZQ92tczK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.872.0/index.min.mjs": "sha384-GMKhlY6fghJOKdMyYRajfHFGRSQl9ybJkYvlIBnN3y+BPo/aJS+d8mQdZQ92tczK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.872.0/LICENSE
```

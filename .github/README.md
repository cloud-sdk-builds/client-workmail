...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+tnmkYajb0w7TCrPJgQBsGdlffLqKJaQdKJFRHFxD+UWugpT+qWjY8buqk38R8EY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.687.0/index.min.mjs": "sha384-+tnmkYajb0w7TCrPJgQBsGdlffLqKJaQdKJFRHFxD+UWugpT+qWjY8buqk38R8EY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.687.0/LICENSE
```

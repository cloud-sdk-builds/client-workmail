...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NkskZHg4SEioXn7+HpbLEfeXRIs6v0kLSBDrD0ETX3KE//dwUFa7rvgYL57lmZ5k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.606.0/index.min.mjs": "sha384-NkskZHg4SEioXn7+HpbLEfeXRIs6v0kLSBDrD0ETX3KE//dwUFa7rvgYL57lmZ5k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.606.0/LICENSE
```

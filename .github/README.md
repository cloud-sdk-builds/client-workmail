...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KNX4bA3HfGVA8rgrUyC7R/WobSGtuh5z51FowzXxJ23rVPLOko0AGSh0Vq3qCyJr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.145.0/index.min.mjs": "sha384-KNX4bA3HfGVA8rgrUyC7R/WobSGtuh5z51FowzXxJ23rVPLOko0AGSh0Vq3qCyJr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.145.0/LICENSE
```

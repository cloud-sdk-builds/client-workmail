...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JrWc4gaH9ENCquexoxs3DJZ76CVFTBqwYWyVC/BcjSPJuoAD+XBcvqN29+NHegoj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.855.0/index.min.mjs": "sha384-JrWc4gaH9ENCquexoxs3DJZ76CVFTBqwYWyVC/BcjSPJuoAD+XBcvqN29+NHegoj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.855.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YEK5a8MlZ3Sv3YZ2lq0KgVdku+ZctKkWUn8+SxnQmM5nR0PScF4q+DawLDXXDd+m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.514.0/index.min.mjs": "sha384-YEK5a8MlZ3Sv3YZ2lq0KgVdku+ZctKkWUn8+SxnQmM5nR0PScF4q+DawLDXXDd+m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.514.0/LICENSE
```

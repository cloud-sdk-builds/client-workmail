...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Plk3WrN0J/PT6hP/smXKo3lQ9Hc9RzU1rpamDOMZErAeejwMmO8Y4bczU71qdx+v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.267.0/index.min.mjs": "sha384-Plk3WrN0J/PT6hP/smXKo3lQ9Hc9RzU1rpamDOMZErAeejwMmO8Y4bczU71qdx+v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.267.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uKDL2ibg8ldLSR+7BmFeGjfrNEPB58lZB/Q8F1GJNM//1Ll3pVD5fpXX8VbGL/D/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.893.0/index.min.mjs": "sha384-uKDL2ibg8ldLSR+7BmFeGjfrNEPB58lZB/Q8F1GJNM//1Ll3pVD5fpXX8VbGL/D/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.893.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.10.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.10.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WTAtcyOw1EOfFYqxLqJTdrj/QaGj7v48b4rHPDZ0dEvxse1OPHaB5atdPORnff2d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.10.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.10.0/index.min.mjs": "sha384-WTAtcyOw1EOfFYqxLqJTdrj/QaGj7v48b4rHPDZ0dEvxse1OPHaB5atdPORnff2d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.10.0/LICENSE
```

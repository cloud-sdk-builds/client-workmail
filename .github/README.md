...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X5/WWCdZZ/hV/rDCetJWthoZdnC2emjf8v4DivNAlLGDlTTH1JympjH8RslYbaW5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.201.0/index.min.mjs": "sha384-X5/WWCdZZ/hV/rDCetJWthoZdnC2emjf8v4DivNAlLGDlTTH1JympjH8RslYbaW5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.201.0/LICENSE
```

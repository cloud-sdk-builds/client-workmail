...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.810.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.810.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5/Zx9yprJKD+zGEAeQMhqpbt/KNhH/ikEsifWDDS8Uz5XEql82PtrG6P5jENHh0V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.810.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.810.0/index.min.mjs": "sha384-5/Zx9yprJKD+zGEAeQMhqpbt/KNhH/ikEsifWDDS8Uz5XEql82PtrG6P5jENHh0V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.810.0/LICENSE
```

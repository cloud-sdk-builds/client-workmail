...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yMD69anLL2e88I8gUDc0JiDJ+uULgOw2r9QHvzp96XozD5DDrR+4Fjb3enh00Ua5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.398.0/index.min.mjs": "sha384-yMD69anLL2e88I8gUDc0JiDJ+uULgOw2r9QHvzp96XozD5DDrR+4Fjb3enh00Ua5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.398.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gqkxZshbDYhrwgfaK9KS91U8MyIz0VV4MJpneX2dyFPuB9e6aS+JMoRXXmjwrg8X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.574.0/index.min.mjs": "sha384-gqkxZshbDYhrwgfaK9KS91U8MyIz0VV4MJpneX2dyFPuB9e6aS+JMoRXXmjwrg8X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.574.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1042.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1042.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FLjecmk04AaD4w7GD72ZaG2+wFed0cXYUPO9CfqNQCi2azBTm+thBJuP8ivZUhkR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1042.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1042.0/index.min.mjs": "sha384-FLjecmk04AaD4w7GD72ZaG2+wFed0cXYUPO9CfqNQCi2azBTm+thBJuP8ivZUhkR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1042.0/LICENSE
```

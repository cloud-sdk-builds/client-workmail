...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VZiLQFb77UVI07XP8ESl+qrg+5ZfJoiF0B6fHNtDPaeJpsKDysqxcVAMA3VZfvqM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.292.0/index.min.mjs": "sha384-VZiLQFb77UVI07XP8ESl+qrg+5ZfJoiF0B6fHNtDPaeJpsKDysqxcVAMA3VZfvqM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.292.0/LICENSE
```

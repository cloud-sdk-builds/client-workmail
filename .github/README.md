...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QYRR7m2PB9fusMPT7i7Vw5bTSqrzqNKjpd5YogzSarjzg1UFDYfg0hwHsCgr8GjW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.78.0/index.min.mjs": "sha384-QYRR7m2PB9fusMPT7i7Vw5bTSqrzqNKjpd5YogzSarjzg1UFDYfg0hwHsCgr8GjW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.78.0/LICENSE
```

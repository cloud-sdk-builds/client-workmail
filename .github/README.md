...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.281.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.281.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2zHwn4pVU9zIQPURb9wMCi2iT8A/PhUN6U3sbtoGX1WTG6d6swwkHbihF8/bQwn9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.281.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.281.0/index.min.mjs": "sha384-2zHwn4pVU9zIQPURb9wMCi2iT8A/PhUN6U3sbtoGX1WTG6d6swwkHbihF8/bQwn9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.281.0/LICENSE
```

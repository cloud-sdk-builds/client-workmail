...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fh9h/G5XKaeSdGKcHUpRk2HNOuKxrnwYhYLNwdplRsAeoG37IEOTLczPoK+bvGxP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.564.0/index.min.mjs": "sha384-fh9h/G5XKaeSdGKcHUpRk2HNOuKxrnwYhYLNwdplRsAeoG37IEOTLczPoK+bvGxP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.564.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iTwOdge5KZ4vmxnaVKIh0c3jOwAgWak7+YdJJDIgW9w1pyYRVsU6LB129nEmOohq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.712.0/index.min.mjs": "sha384-iTwOdge5KZ4vmxnaVKIh0c3jOwAgWak7+YdJJDIgW9w1pyYRVsU6LB129nEmOohq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.712.0/LICENSE
```

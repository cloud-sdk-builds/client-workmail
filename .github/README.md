...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-53mQST91cET6pBJGERvv6tLIg4JaT6kydAUxB1vRxAlJthgcenU5GGWp+sCDB+IH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.33.0/index.min.mjs": "sha384-53mQST91cET6pBJGERvv6tLIg4JaT6kydAUxB1vRxAlJthgcenU5GGWp+sCDB+IH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.33.0/LICENSE
```

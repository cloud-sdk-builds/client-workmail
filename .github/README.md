...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.409.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.409.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BE+7mFgc59JKSee4Y/tHyAez3C9+OthgoXfXthzafVXv4MMd+frdgFPn6mnHQtXg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.409.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.409.0/index.min.mjs": "sha384-BE+7mFgc59JKSee4Y/tHyAez3C9+OthgoXfXthzafVXv4MMd+frdgFPn6mnHQtXg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.409.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hx2JYdrHz5ol0cBkZZ3YZ8Ntv3+o2eaMtwu+f/JKjqB7eO+pZl/pB9XSismYQUND
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.894.0/index.min.mjs": "sha384-hx2JYdrHz5ol0cBkZZ3YZ8Ntv3+o2eaMtwu+f/JKjqB7eO+pZl/pB9XSismYQUND"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.894.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.21.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.21.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JQtWSIZ/8CU41TMrE12kMHlbxjxlBfXCMEnV9MOO9vHGRCyoQ+JHHj7xfDePKa08
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.21.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.21.0/index.min.mjs": "sha384-JQtWSIZ/8CU41TMrE12kMHlbxjxlBfXCMEnV9MOO9vHGRCyoQ+JHHj7xfDePKa08"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.21.0/LICENSE
```

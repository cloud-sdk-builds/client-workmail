...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.262.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.262.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Pl0LcJh5D4lnsjTfThzIpINllU26WjmnYGmS4TuYLN5AYtI7pMW0Q4hXEQ/IXTWD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.262.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.262.0/index.min.mjs": "sha384-Pl0LcJh5D4lnsjTfThzIpINllU26WjmnYGmS4TuYLN5AYtI7pMW0Q4hXEQ/IXTWD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.262.0/LICENSE
```

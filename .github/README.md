...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wgQkf2soHUm1P8sA/60LsGi+gLLmLA2+vYAz4HYRj0m0LNEaeVO4Rpx07NgsEzeg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.990.0/index.min.mjs": "sha384-wgQkf2soHUm1P8sA/60LsGi+gLLmLA2+vYAz4HYRj0m0LNEaeVO4Rpx07NgsEzeg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.990.0/LICENSE
```

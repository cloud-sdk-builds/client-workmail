...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PA/RW5OAPuKOHW6//yPNTTiuw0B7LmHAWi/l6uiGjuVV+DY9tCEPkSdeA5JWggoi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.105.0/index.min.mjs": "sha384-PA/RW5OAPuKOHW6//yPNTTiuw0B7LmHAWi/l6uiGjuVV+DY9tCEPkSdeA5JWggoi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.105.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WnkLD8769/BThFgD2/3o/bySk6B9iOIoP0eeCy3MU57+XXGSgKFtUgjv4+g5NDGn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.622.0/index.min.mjs": "sha384-WnkLD8769/BThFgD2/3o/bySk6B9iOIoP0eeCy3MU57+XXGSgKFtUgjv4+g5NDGn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.622.0/LICENSE
```

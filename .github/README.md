...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bn+7IBq4o8uTyB1Bpfw+YNz170+BokNJvEo6him0CUXoqFFAHGi3c5lea/juIp0T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.22.0/index.min.mjs": "sha384-Bn+7IBq4o8uTyB1Bpfw+YNz170+BokNJvEo6him0CUXoqFFAHGi3c5lea/juIp0T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.22.0/LICENSE
```

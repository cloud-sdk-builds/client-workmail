...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.515.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.515.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lsCZgkcE+YriTm7uJSxAPRS3+rjwY42eRBSOcZQCua1Of+GPYgwOrqao1vdAweAI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.515.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.515.0/index.min.mjs": "sha384-lsCZgkcE+YriTm7uJSxAPRS3+rjwY42eRBSOcZQCua1Of+GPYgwOrqao1vdAweAI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.515.0/LICENSE
```

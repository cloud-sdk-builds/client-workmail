...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.184.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.184.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4whM6nzNGfDStz/TYLUW+bSHjT+bELP1At765nB6wiibPTeosMxQn1x7tzzgDcHf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.184.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.184.0/index.min.mjs": "sha384-4whM6nzNGfDStz/TYLUW+bSHjT+bELP1At765nB6wiibPTeosMxQn1x7tzzgDcHf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.184.0/LICENSE
```

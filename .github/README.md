...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S4ykXwx4gMPsYh01j7v1dFnVk7E3mjBDZyqc6ZkijlTUzfvhvUWxosJHst46avuf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.438.0/index.min.mjs": "sha384-S4ykXwx4gMPsYh01j7v1dFnVk7E3mjBDZyqc6ZkijlTUzfvhvUWxosJHst46avuf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.438.0/LICENSE
```

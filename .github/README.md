...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Sj4e/ixzTazlol9gEoCYA/lpM2+5RE+bml1jK/SlRH0YycLn0Us/XB7kiNYPbq0m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.967.0/index.min.mjs": "sha384-Sj4e/ixzTazlol9gEoCYA/lpM2+5RE+bml1jK/SlRH0YycLn0Us/XB7kiNYPbq0m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.967.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.180.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.180.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xbi0y9dmURdVUsqvcdsizv3XMPJb5Zg3BNkKqojutQfvqct1dVdLc89I2EgQcBIP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.180.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.180.0/index.min.mjs": "sha384-xbi0y9dmURdVUsqvcdsizv3XMPJb5Zg3BNkKqojutQfvqct1dVdLc89I2EgQcBIP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.180.0/LICENSE
```

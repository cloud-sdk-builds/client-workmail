...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yG89Kp+QtFIaT/8KcItz+76lHRqnyG+gCvXsi1RDUF2S9I1piaV0ZrmJJ2rVrFBn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.621.0/index.min.mjs": "sha384-yG89Kp+QtFIaT/8KcItz+76lHRqnyG+gCvXsi1RDUF2S9I1piaV0ZrmJJ2rVrFBn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.621.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8NA/h4oeaiGE6a2P1AsDnXcFNxYnRD3CNMlybRbTMuZp5jndLwa8WImhCKlBwK7n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.563.0/index.min.mjs": "sha384-8NA/h4oeaiGE6a2P1AsDnXcFNxYnRD3CNMlybRbTMuZp5jndLwa8WImhCKlBwK7n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.563.0/LICENSE
```

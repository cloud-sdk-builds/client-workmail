...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pmdh0NShLota0nAfSKZxokI3q2xmofoaV7UHv8F321QccpbFhiVuX/6HsRr8yFq9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.966.0/index.min.mjs": "sha384-pmdh0NShLota0nAfSKZxokI3q2xmofoaV7UHv8F321QccpbFhiVuX/6HsRr8yFq9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.966.0/LICENSE
```

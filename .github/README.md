...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fWhWwG9KfJMfrkbmkCV+O7Jvxa/pHVRUDkI6722omXU2OfLkz7zCbOz+PdIqxo1v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.821.0/index.min.mjs": "sha384-fWhWwG9KfJMfrkbmkCV+O7Jvxa/pHVRUDkI6722omXU2OfLkz7zCbOz+PdIqxo1v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.821.0/LICENSE
```

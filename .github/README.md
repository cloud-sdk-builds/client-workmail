...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GloI9IFxef62T7CqE2PkO3ynJAV1aWYaPbOj1EF1u9wJipqYuh7xR5DvHQntnsv4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.901.0/index.min.mjs": "sha384-GloI9IFxef62T7CqE2PkO3ynJAV1aWYaPbOj1EF1u9wJipqYuh7xR5DvHQntnsv4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.901.0/LICENSE
```

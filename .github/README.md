...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nQZMkSnKZAoZd/uFj0yKQ7SmJtBlCztXG/iFH9f/YDm+tYMHGHyHfg8NLzt2eGic
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.181.0/index.min.mjs": "sha384-nQZMkSnKZAoZd/uFj0yKQ7SmJtBlCztXG/iFH9f/YDm+tYMHGHyHfg8NLzt2eGic"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.181.0/LICENSE
```

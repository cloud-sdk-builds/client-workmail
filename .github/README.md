...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-chxPgkUhj+Pl0wkyBb7L0Xa4AVK5KNJB4rA7Q0bQabLWMhbJd9GbxYC397kjHjfv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.919.0/index.min.mjs": "sha384-chxPgkUhj+Pl0wkyBb7L0Xa4AVK5KNJB4rA7Q0bQabLWMhbJd9GbxYC397kjHjfv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.919.0/LICENSE
```

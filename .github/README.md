...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lz+bYVXq8j7UD1oto28XlV3Vl2PF9aO6rFxkvdrBlyd61eyHK2rY/F2tVVqJu5s8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.386.0/index.min.mjs": "sha384-lz+bYVXq8j7UD1oto28XlV3Vl2PF9aO6rFxkvdrBlyd61eyHK2rY/F2tVVqJu5s8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.386.0/LICENSE
```

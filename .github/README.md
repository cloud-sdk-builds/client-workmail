...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.171.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.171.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oQXCruVHzkOgCN1G4M9hxhyU+ZmIaPpE3BEo5X74qB6OprqvOZ8a8fbyVO5gM/yY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.171.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.171.0/index.min.mjs": "sha384-oQXCruVHzkOgCN1G4M9hxhyU+ZmIaPpE3BEo5X74qB6OprqvOZ8a8fbyVO5gM/yY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.171.0/LICENSE
```

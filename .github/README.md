...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kGLknEfTxY2XzUteGTBPtF3s/zsi9MzdDGWrH0vaxtO6sZwIYHnV5tbpweMywc4G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.848.0/index.min.mjs": "sha384-kGLknEfTxY2XzUteGTBPtF3s/zsi9MzdDGWrH0vaxtO6sZwIYHnV5tbpweMywc4G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.848.0/LICENSE
```

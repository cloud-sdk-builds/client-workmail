...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.195.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.195.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n08WfXi5HZXjkgasFW9FOUaKRrE+Q3S0iO02e82QOcH4gFvm24qtp6kvCTq0s+B5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.195.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.195.0/index.min.mjs": "sha384-n08WfXi5HZXjkgasFW9FOUaKRrE+Q3S0iO02e82QOcH4gFvm24qtp6kvCTq0s+B5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.195.0/LICENSE
```

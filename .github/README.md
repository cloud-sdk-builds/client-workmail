...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CHGTTf4F5UtHJTL3SoKWMZ1oqpQHopD6ctiCq+HZT3rph6O6dxNksFrFp48EChDc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.170.0/index.min.mjs": "sha384-CHGTTf4F5UtHJTL3SoKWMZ1oqpQHopD6ctiCq+HZT3rph6O6dxNksFrFp48EChDc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.170.0/LICENSE
```

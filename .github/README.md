...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DdSmJrsVPBt0gt/7dUmuv34r7nNK+q/ZlsQe402cJeEnlbyZhZQN+mVnx0Ga3ESU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.890.0/index.min.mjs": "sha384-DdSmJrsVPBt0gt/7dUmuv34r7nNK+q/ZlsQe402cJeEnlbyZhZQN+mVnx0Ga3ESU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.890.0/LICENSE
```

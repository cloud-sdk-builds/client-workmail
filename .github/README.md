...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A3aI7XgZ9o/PPrwcpy+aQwSkXi9kPrRiN2yHPD+9SnDkiG+DWqhQyhZ0nr2f9R1o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.241.0/index.min.mjs": "sha384-A3aI7XgZ9o/PPrwcpy+aQwSkXi9kPrRiN2yHPD+9SnDkiG+DWqhQyhZ0nr2f9R1o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.241.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hM3I0apZvd5Z0HWRUyH7q5VMOE87wRJP4B6v0pL55Oj/i8oTCEh114ntrTT5Xlto
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.632.0/index.min.mjs": "sha384-hM3I0apZvd5Z0HWRUyH7q5VMOE87wRJP4B6v0pL55Oj/i8oTCEh114ntrTT5Xlto"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.632.0/LICENSE
```

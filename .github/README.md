...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lgewsS5vtfmHROoyQ+JTPpFXJdIxCOoSdWg+ZsfsnsbnxlYGWe4O+egE98JAk0JM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.583.0/index.min.mjs": "sha384-lgewsS5vtfmHROoyQ+JTPpFXJdIxCOoSdWg+ZsfsnsbnxlYGWe4O+egE98JAk0JM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.583.0/LICENSE
```

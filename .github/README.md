...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gx4kjhJqWd9vPymiHQGsNDkieOyzB6P5Du+h5Eg1vNiXFxq9GGRYhPz39JhRGKb0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.863.0/index.min.mjs": "sha384-Gx4kjhJqWd9vPymiHQGsNDkieOyzB6P5Du+h5Eg1vNiXFxq9GGRYhPz39JhRGKb0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.863.0/LICENSE
```

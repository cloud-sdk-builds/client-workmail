...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oQj7O6gJ7l9LXGLcJAS1TIUvCiyoKr36cgkcdwPE7PSImxkwqo4NODd5xlp8BOO8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.858.0/index.min.mjs": "sha384-oQj7O6gJ7l9LXGLcJAS1TIUvCiyoKr36cgkcdwPE7PSImxkwqo4NODd5xlp8BOO8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.858.0/LICENSE
```

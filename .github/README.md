...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fiDCgbEPMZnBztSg2lsB7lCKyA151LcwnzhhCHbtvp49IXSL/D7Fk08ClVpHMaSQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.521.0/index.min.mjs": "sha384-fiDCgbEPMZnBztSg2lsB7lCKyA151LcwnzhhCHbtvp49IXSL/D7Fk08ClVpHMaSQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.521.0/LICENSE
```

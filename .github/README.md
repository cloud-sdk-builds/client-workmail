...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kruGClIgby3grKthmEHHgk2QG4JGXLrZnggWqHku1VYA1K+eufeOtBZajoWewL3q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.978.0/index.min.mjs": "sha384-kruGClIgby3grKthmEHHgk2QG4JGXLrZnggWqHku1VYA1K+eufeOtBZajoWewL3q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.978.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.328.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.328.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TounkFPZNVepULV7idwGdxq/vD3d+Ywn13p5KCZ89tMTyql+SeNl34Nmgt57pFJa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.328.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.328.0/index.min.mjs": "sha384-TounkFPZNVepULV7idwGdxq/vD3d+Ywn13p5KCZ89tMTyql+SeNl34Nmgt57pFJa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.328.0/LICENSE
```

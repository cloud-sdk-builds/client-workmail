...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.56.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.56.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5y/QrPDlQYLwUc6xWBxaE4+nFRb091fhvWMEwbRb0DXM6v32xA0tCEL4KAkaxwaF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.56.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.56.0/index.min.mjs": "sha384-5y/QrPDlQYLwUc6xWBxaE4+nFRb091fhvWMEwbRb0DXM6v32xA0tCEL4KAkaxwaF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.56.0/LICENSE
```

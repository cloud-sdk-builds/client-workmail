...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.437.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.437.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hbSraZXIwyEdEy/O7Y1VMexcUSOazUDw88d/s+7DtTYyXYEZVI3GRACHMTx/L60X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.437.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.437.0/index.min.mjs": "sha384-hbSraZXIwyEdEy/O7Y1VMexcUSOazUDw88d/s+7DtTYyXYEZVI3GRACHMTx/L60X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.437.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-38Jw3GNklh2+kRmI/YHiIxP+q0s4A2+Wd9uvGYSvc1IYDtfOjyobHa9Gicfp73gt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.686.0/index.min.mjs": "sha384-38Jw3GNklh2+kRmI/YHiIxP+q0s4A2+Wd9uvGYSvc1IYDtfOjyobHa9Gicfp73gt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.686.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xa9IzRnIGyIzvh9Ifo4DUSJM1XyrFPzAefSWi+04gfogtJ+QB14QxwUur3Gov6S4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.252.0/index.min.mjs": "sha384-Xa9IzRnIGyIzvh9Ifo4DUSJM1XyrFPzAefSWi+04gfogtJ+QB14QxwUur3Gov6S4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.252.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.495.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.495.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tHkzfb382XnFl+CNPJ7tAegWPzKMS9spMNmpnsMc7QjHqJl1KyWdCP2orIcGp3fS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.495.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.495.0/index.min.mjs": "sha384-tHkzfb382XnFl+CNPJ7tAegWPzKMS9spMNmpnsMc7QjHqJl1KyWdCP2orIcGp3fS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.495.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NWwtfk4D+HR7kFjgnrG0ETdJIc4A/gS7PKOoJwGo+ZMMqPVEDQEZtgRnzllL2BlS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.128.0/index.min.mjs": "sha384-NWwtfk4D+HR7kFjgnrG0ETdJIc4A/gS7PKOoJwGo+ZMMqPVEDQEZtgRnzllL2BlS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.128.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oGIEtBBPlFZLbyE1F3fpHXYSPXSkaWekYzCy/GoWb1pLa0w/Aw7bv/x2LGd9Jelv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.507.0/index.min.mjs": "sha384-oGIEtBBPlFZLbyE1F3fpHXYSPXSkaWekYzCy/GoWb1pLa0w/Aw7bv/x2LGd9Jelv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.507.0/LICENSE
```

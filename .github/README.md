...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.11.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.11.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CNWzosn7ft3eHeMTiGQQ/R+k5AoXhQCBlF++NddSiwX6dBb6GFaeExrX7lMStNOe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.11.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.11.0/index.min.mjs": "sha384-CNWzosn7ft3eHeMTiGQQ/R+k5AoXhQCBlF++NddSiwX6dBb6GFaeExrX7lMStNOe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.11.0/LICENSE
```

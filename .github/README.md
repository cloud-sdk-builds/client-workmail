...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Fs74VV1Dhu5aSELVnCgU9Q8kt6PLGnSBPxrpRapK3Mqb9/WRtuDXJaewFzvwdk03
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.999.0/index.min.mjs": "sha384-Fs74VV1Dhu5aSELVnCgU9Q8kt6PLGnSBPxrpRapK3Mqb9/WRtuDXJaewFzvwdk03"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.999.0/LICENSE
```

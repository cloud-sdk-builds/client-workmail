...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xy9QqZu/nyJCnSpuMTS1MbepQjyD6cReWr9qaguJuvPVDicRyo2ewgKkFcXmMKQl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.970.0/index.min.mjs": "sha384-xy9QqZu/nyJCnSpuMTS1MbepQjyD6cReWr9qaguJuvPVDicRyo2ewgKkFcXmMKQl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.970.0/LICENSE
```

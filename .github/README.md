...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.17.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.17.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x0EAaBMMtsVMoUHDwU/MK3JIR28GaCqU83qA3HHTmBPjfgonO3bvsxI05OBMbJHF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.17.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.17.0/index.min.mjs": "sha384-x0EAaBMMtsVMoUHDwU/MK3JIR28GaCqU83qA3HHTmBPjfgonO3bvsxI05OBMbJHF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.17.0/LICENSE
```

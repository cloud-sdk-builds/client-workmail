...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XK756rWFZ2Jdf1GwWiv9hTB0RdnHyK0l1uDJ55QPQsf/AUx1+/6GgygepsYadt8T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.952.0/index.min.mjs": "sha384-XK756rWFZ2Jdf1GwWiv9hTB0RdnHyK0l1uDJ55QPQsf/AUx1+/6GgygepsYadt8T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.952.0/LICENSE
```

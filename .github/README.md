...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4ALmagt0d7ROguszZPB6e9V71PJQfjj/2zVpOfb3eFiqQlAi2ZZR0dAN0ifvXX6P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.946.0/index.min.mjs": "sha384-4ALmagt0d7ROguszZPB6e9V71PJQfjj/2zVpOfb3eFiqQlAi2ZZR0dAN0ifvXX6P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.946.0/LICENSE
```

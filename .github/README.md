...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-81nFmCZ4n+faBDREsuaqg6pVGklMn+hg2vfaNwZCE3LDtC2/lknPu7yARU4n3D/e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.79.0/index.min.mjs": "sha384-81nFmCZ4n+faBDREsuaqg6pVGklMn+hg2vfaNwZCE3LDtC2/lknPu7yARU4n3D/e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.79.0/LICENSE
```

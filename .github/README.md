...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-50vJoHKyNiD0gxu2SdZRuyorB0TTiSIa42coPhZq7Ez/gVHbpaW2X40TYqJHTHQS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.996.0/index.min.mjs": "sha384-50vJoHKyNiD0gxu2SdZRuyorB0TTiSIa42coPhZq7Ez/gVHbpaW2X40TYqJHTHQS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.996.0/LICENSE
```

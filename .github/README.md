...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AEXnFQfi9NQW/B9lX11r2rvvTsLYUIaLJ59B+z3WHq46qKfD3vnvMfx+6HR64AzV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.911.0/index.min.mjs": "sha384-AEXnFQfi9NQW/B9lX11r2rvvTsLYUIaLJ59B+z3WHq46qKfD3vnvMfx+6HR64AzV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.911.0/LICENSE
```

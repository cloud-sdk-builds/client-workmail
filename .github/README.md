...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YROhATkwK+I4v5Z5rHRPMY+ztCzERU4Eh7R3yyCDqYE62QO7ubx6/sSds1p0JKQM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.741.0/index.min.mjs": "sha384-YROhATkwK+I4v5Z5rHRPMY+ztCzERU4Eh7R3yyCDqYE62QO7ubx6/sSds1p0JKQM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.741.0/LICENSE
```

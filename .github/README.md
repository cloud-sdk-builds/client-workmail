...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.266.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.266.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KT2SCczxWnwJ4uZHJIfZrznuo8KnL+P/pYb5ILEO3QcIcGkCquhTMMQsGkSZpSTi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.266.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.266.0/index.min.mjs": "sha384-KT2SCczxWnwJ4uZHJIfZrznuo8KnL+P/pYb5ILEO3QcIcGkCquhTMMQsGkSZpSTi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.266.0/LICENSE
```

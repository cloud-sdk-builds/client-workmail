...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OwpwnXo1Vq8/SJD88IR5gwru/u0mw5O6jBVLZ2hQdUFPcdclv3B5Fke0ETWBA6SA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.577.0/index.min.mjs": "sha384-OwpwnXo1Vq8/SJD88IR5gwru/u0mw5O6jBVLZ2hQdUFPcdclv3B5Fke0ETWBA6SA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.577.0/LICENSE
```

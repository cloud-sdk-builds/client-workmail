...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C1OGCGW+Gd78CHnsYdGcjJk/+U+AI3VOGQqAc+fQDzj7GuspSDy62AZgPquYnH/K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.846.0/index.min.mjs": "sha384-C1OGCGW+Gd78CHnsYdGcjJk/+U+AI3VOGQqAc+fQDzj7GuspSDy62AZgPquYnH/K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.846.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4p8Adn4VbfrzWrr0sC+wYI8EvkPyGQ+0fYzCiUZefeUYzoSzLNC2GMY9ARvtjJ9X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.325.0/index.min.mjs": "sha384-4p8Adn4VbfrzWrr0sC+wYI8EvkPyGQ+0fYzCiUZefeUYzoSzLNC2GMY9ARvtjJ9X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.325.0/LICENSE
```

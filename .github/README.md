...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oT/iFzqNvhoSr+OZ3602feKcyHs1GHNoDgmIIMiYh8xP0YK984CAk1Mv18DnAxF1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.682.0/index.min.mjs": "sha384-oT/iFzqNvhoSr+OZ3602feKcyHs1GHNoDgmIIMiYh8xP0YK984CAk1Mv18DnAxF1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.682.0/LICENSE
```

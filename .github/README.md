...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.427.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.427.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KtOEFusNI4EaZog7+wn2Zf8Vpn14V0M5PwwXxcQD0OMBe5GbnsmklH3k9zlto2cQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.427.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.427.0/index.min.mjs": "sha384-KtOEFusNI4EaZog7+wn2Zf8Vpn14V0M5PwwXxcQD0OMBe5GbnsmklH3k9zlto2cQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.427.0/LICENSE
```

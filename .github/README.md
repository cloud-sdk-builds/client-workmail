...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.342.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.342.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AsY27c/1m7YMaFVg3RVtpDiM4ZIMOV9ZyMzS0nmTAqJCw7F/ttGS/EqE8yUWRwZw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.342.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.342.0/index.min.mjs": "sha384-AsY27c/1m7YMaFVg3RVtpDiM4ZIMOV9ZyMzS0nmTAqJCw7F/ttGS/EqE8yUWRwZw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.342.0/LICENSE
```

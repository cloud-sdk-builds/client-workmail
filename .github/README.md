...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2GWiyJVNs2wGkWnbM5AVUtCiALKD+vZ3+i2FntLArJclgW0lzKNzJUlVuqMuRwkp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.569.0/index.min.mjs": "sha384-2GWiyJVNs2wGkWnbM5AVUtCiALKD+vZ3+i2FntLArJclgW0lzKNzJUlVuqMuRwkp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.569.0/LICENSE
```

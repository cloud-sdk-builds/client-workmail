...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8uWsLGMz0f+QJK7MCfYotYt7+kyfgLMqlA2P2XcGpSvi4jQrogEdyKmFlhIQUv4Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.955.0/index.min.mjs": "sha384-8uWsLGMz0f+QJK7MCfYotYt7+kyfgLMqlA2P2XcGpSvi4jQrogEdyKmFlhIQUv4Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.955.0/LICENSE
```

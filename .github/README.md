...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-epbtvMJ9UTau/Dyq11fnPN6+xOQA26ws2JWkpLy98LQM06PdTCrR3hQO/+oivUY8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.451.0/index.min.mjs": "sha384-epbtvMJ9UTau/Dyq11fnPN6+xOQA26ws2JWkpLy98LQM06PdTCrR3hQO/+oivUY8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.451.0/LICENSE
```

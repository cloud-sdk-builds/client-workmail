...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-ohlVytHqsnhKkck72G1XGqiMkTwViPxzFu+3/LGNanjJUj8OR50moVpkEAk4QVfm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.118.1/index.min.mjs": "sha384-ohlVytHqsnhKkck72G1XGqiMkTwViPxzFu+3/LGNanjJUj8OR50moVpkEAk4QVfm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.118.1/LICENSE
```

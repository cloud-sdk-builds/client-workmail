...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1QN/1j6oLT7wfT94M5Dd1WY/XamXlO6o8ejA4ErPeqefqVx0jEcB52PU+WXappHS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.940.0/index.min.mjs": "sha384-1QN/1j6oLT7wfT94M5Dd1WY/XamXlO6o8ejA4ErPeqefqVx0jEcB52PU+WXappHS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.940.0/LICENSE
```

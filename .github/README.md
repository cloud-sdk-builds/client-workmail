...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I9v234rrRBfOUS5W7g+KRbNICtcvJ2wzotoMub5mDPZe1cDlgOeZTXEgCOEstP8P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.131.0/index.min.mjs": "sha384-I9v234rrRBfOUS5W7g+KRbNICtcvJ2wzotoMub5mDPZe1cDlgOeZTXEgCOEstP8P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.131.0/LICENSE
```

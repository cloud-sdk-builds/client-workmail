...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-31uNPNRlAn7QCHGkuhCdTbjViQnV77KFRIbtgWyaVgPtOwZ0tWZ5YYGP0J6zunKl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.38.0/index.min.mjs": "sha384-31uNPNRlAn7QCHGkuhCdTbjViQnV77KFRIbtgWyaVgPtOwZ0tWZ5YYGP0J6zunKl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.38.0/LICENSE
```

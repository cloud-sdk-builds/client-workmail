...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5yT9lxflEngR2XYcS4/lSzTHO0MMZDbZDC5vtVYWrmzmnSs9vEjTp7XhaPAC2UGl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.679.0/index.min.mjs": "sha384-5yT9lxflEngR2XYcS4/lSzTHO0MMZDbZDC5vtVYWrmzmnSs9vEjTp7XhaPAC2UGl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.679.0/LICENSE
```

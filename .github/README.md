...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6RXwKQKb7VjHKfRT3bhjo1RC1J+Pg/VKGb4faoJUbrZvVTdIxQErIrmOZTBUSu1g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.435.0/index.min.mjs": "sha384-6RXwKQKb7VjHKfRT3bhjo1RC1J+Pg/VKGb4faoJUbrZvVTdIxQErIrmOZTBUSu1g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.435.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-pW9VcUiCtS/N2uYHt52JSReayZy2OqGe2IGoiQzJqiAw0QLArNeLeVh12dZ2nRoZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.321.1/index.min.mjs": "sha384-pW9VcUiCtS/N2uYHt52JSReayZy2OqGe2IGoiQzJqiAw0QLArNeLeVh12dZ2nRoZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.321.1/LICENSE
```

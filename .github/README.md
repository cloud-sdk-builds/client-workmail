...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z+BRA1ZmSomUI1xet2Ar0ebxXrfmj8kVmju5/H5DuYf/rsr8ZXhSCJb8gZlYo7ap
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.962.0/index.min.mjs": "sha384-Z+BRA1ZmSomUI1xet2Ar0ebxXrfmj8kVmju5/H5DuYf/rsr8ZXhSCJb8gZlYo7ap"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.962.0/LICENSE
```

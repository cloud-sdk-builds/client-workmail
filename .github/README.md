...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UAaBhuJcMqE6u52zpge2MDL2iCcGOp1GsdXLa2HAZZitQqHx8oHpPif6Y+AO7kPG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.178.0/index.min.mjs": "sha384-UAaBhuJcMqE6u52zpge2MDL2iCcGOp1GsdXLa2HAZZitQqHx8oHpPif6Y+AO7kPG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.178.0/LICENSE
```

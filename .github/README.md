...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1037.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1037.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pDk0rtcdd748GT6X+mebrBzifLdHShCWp65wOVQNUuw1D1jfFYp+u0J1nBDfNRAr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1037.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1037.0/index.min.mjs": "sha384-pDk0rtcdd748GT6X+mebrBzifLdHShCWp65wOVQNUuw1D1jfFYp+u0J1nBDfNRAr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1037.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-u54xbWo/++4KfFSrGyb6BKmUakuK3zAIwcyr7cWpIjmPm10P5/3cY7lBnL/SiL/f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.47.1/index.min.mjs": "sha384-u54xbWo/++4KfFSrGyb6BKmUakuK3zAIwcyr7cWpIjmPm10P5/3cY7lBnL/SiL/f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.47.1/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e/E1KCdBNuMk+p9fSWe3mAsW3rw2kWAG+bT8x+IJY+8l6MrcbvQVGnsBszS/nPyv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.662.0/index.min.mjs": "sha384-e/E1KCdBNuMk+p9fSWe3mAsW3rw2kWAG+bT8x+IJY+8l6MrcbvQVGnsBszS/nPyv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.662.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a9sd86e2IXhK+V/A8ovkuiSCB7g+oErdT7e/kUzZy/XTGiGpiSKAmOe19zPLnI1m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.649.0/index.min.mjs": "sha384-a9sd86e2IXhK+V/A8ovkuiSCB7g+oErdT7e/kUzZy/XTGiGpiSKAmOe19zPLnI1m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.649.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1018.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1018.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N0m4jXvtBTX1kI1M4CspFMdUAcQAX+NJwjv5/4B2FwG6nHMtEsH/YIK1ofMEpdTr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1018.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1018.0/index.min.mjs": "sha384-N0m4jXvtBTX1kI1M4CspFMdUAcQAX+NJwjv5/4B2FwG6nHMtEsH/YIK1ofMEpdTr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1018.0/LICENSE
```

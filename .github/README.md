...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vgK8C2LKst+0Dcl/weCOVq4TJqgM2sbStq6Iy/IcQ2Bb2imCxH658SB/uU4atd2h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.163.0/index.min.mjs": "sha384-vgK8C2LKst+0Dcl/weCOVq4TJqgM2sbStq6Iy/IcQ2Bb2imCxH658SB/uU4atd2h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.163.0/LICENSE
```

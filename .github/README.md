...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1015.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1015.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0p23/gosPhqJUl6G9a+FXgHJFwhIgJpvlp7awgt0JNpB1F/Mvg9YvovgKuWj8fIa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1015.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1015.0/index.min.mjs": "sha384-0p23/gosPhqJUl6G9a+FXgHJFwhIgJpvlp7awgt0JNpB1F/Mvg9YvovgKuWj8fIa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1015.0/LICENSE
```

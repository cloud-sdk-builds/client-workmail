...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MBkaipoJhP+35qM6v05KR14Nw7m9kfcqK0FXm5mA3dZlNrHpRlBONyrriG4LjFeu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.15.0/index.min.mjs": "sha384-MBkaipoJhP+35qM6v05KR14Nw7m9kfcqK0FXm5mA3dZlNrHpRlBONyrriG4LjFeu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.15.0/LICENSE
```

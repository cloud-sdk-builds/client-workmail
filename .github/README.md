...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.4.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.4.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YUMey5vFnO5P0CdgPX6GZtfw2DEMSsum98LCUT801akaIZvVA3kw5wJBAvj+MhTC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.4.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.4.0/index.min.mjs": "sha384-YUMey5vFnO5P0CdgPX6GZtfw2DEMSsum98LCUT801akaIZvVA3kw5wJBAvj+MhTC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.4.0/LICENSE
```

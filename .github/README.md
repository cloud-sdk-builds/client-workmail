...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V2FNvsWpbsqZFvOwQ33jDPVBpRNv3/GP/o5n/n0QHavErYozN+cFY5XD3CgvfG2o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.160.0/index.min.mjs": "sha384-V2FNvsWpbsqZFvOwQ33jDPVBpRNv3/GP/o5n/n0QHavErYozN+cFY5XD3CgvfG2o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.160.0/LICENSE
```

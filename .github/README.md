...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-otGURWmZbsqkAiNBwMCjiPP1iU/JJkAykElyRMWIr3fh/OrkHP5/F4pfc+0Uo8Mo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.826.0/index.min.mjs": "sha384-otGURWmZbsqkAiNBwMCjiPP1iU/JJkAykElyRMWIr3fh/OrkHP5/F4pfc+0Uo8Mo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.826.0/LICENSE
```

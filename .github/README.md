...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vb6VlAIHkkY2NBZju8BKjODAer26poRx9wQrWZKmdeEdP3pg7zT5fzhXSUo+0JCC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.716.0/index.min.mjs": "sha384-vb6VlAIHkkY2NBZju8BKjODAer26poRx9wQrWZKmdeEdP3pg7zT5fzhXSUo+0JCC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.716.0/LICENSE
```

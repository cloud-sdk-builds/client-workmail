...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M/jGFad8eNsz6rhqroXOvgIFo9HweRI7KHzMwgPLun63c/oQFFz85u2HB+xE5xBo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.777.0/index.min.mjs": "sha384-M/jGFad8eNsz6rhqroXOvgIFo9HweRI7KHzMwgPLun63c/oQFFz85u2HB+xE5xBo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.777.0/LICENSE
```

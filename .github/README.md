...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-grzLO9UzHCcQKV/oEgRJGFnna7iqOLjfNRMwHaQ6o6NrwT0xY5LJw440cvybhOwu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.565.0/index.min.mjs": "sha384-grzLO9UzHCcQKV/oEgRJGFnna7iqOLjfNRMwHaQ6o6NrwT0xY5LJw440cvybhOwu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.565.0/LICENSE
```

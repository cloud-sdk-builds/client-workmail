...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1043.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1043.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+3ekJEiPbVEj3uJfSMd+rdq+WsL7zEc2YHrC1lzW0dub1BoAW43eLqjguCWO/Fmd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1043.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1043.0/index.min.mjs": "sha384-+3ekJEiPbVEj3uJfSMd+rdq+WsL7zEc2YHrC1lzW0dub1BoAW43eLqjguCWO/Fmd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1043.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j5ndtWkbhlgYGo2oKYOU8FwWOI1SjU828r4/00kOMdMdo/XpFWIdx+loKCC0cbJN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.385.0/index.min.mjs": "sha384-j5ndtWkbhlgYGo2oKYOU8FwWOI1SjU828r4/00kOMdMdo/XpFWIdx+loKCC0cbJN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.385.0/LICENSE
```

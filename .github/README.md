...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UnTukPZhE3uQIVuu0OG621NxCvTI9PBmScVfauZU9Ruqjh5UqNEza3uYBKTxei6j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.596.0/index.min.mjs": "sha384-UnTukPZhE3uQIVuu0OG621NxCvTI9PBmScVfauZU9Ruqjh5UqNEza3uYBKTxei6j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.596.0/LICENSE
```

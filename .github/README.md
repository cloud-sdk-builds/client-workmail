...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tslOCt1BQSC6MFZIVje+8s8y1usMLmBPQkhivh3yJkbh81AYE84qpRdQvp4nLScp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.787.0/index.min.mjs": "sha384-tslOCt1BQSC6MFZIVje+8s8y1usMLmBPQkhivh3yJkbh81AYE84qpRdQvp4nLScp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.787.0/LICENSE
```

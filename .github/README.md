...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HMNUqELZUd9y6GCkPe7iyS10dmxlF9yHLgbzR01dsIG4v8+kO+JKe1EPj1OGrweI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.888.0/index.min.mjs": "sha384-HMNUqELZUd9y6GCkPe7iyS10dmxlF9yHLgbzR01dsIG4v8+kO+JKe1EPj1OGrweI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.888.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xUj4qD6s4USg752JpoRtik809dZOAgSSvMcyA9PAMz8jlWpbvd8GkEUotnp9vDqG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.984.0/index.min.mjs": "sha384-xUj4qD6s4USg752JpoRtik809dZOAgSSvMcyA9PAMz8jlWpbvd8GkEUotnp9vDqG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.984.0/LICENSE
```

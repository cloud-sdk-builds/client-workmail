...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RsYXQLC7RG9VgsPJXlWoBINwlqr2JMYOG9dr6X+x7VgtIuDbmcMk6J377PYIFZp0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.934.0/index.min.mjs": "sha384-RsYXQLC7RG9VgsPJXlWoBINwlqr2JMYOG9dr6X+x7VgtIuDbmcMk6J377PYIFZp0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.934.0/LICENSE
```

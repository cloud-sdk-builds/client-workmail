...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z6MAK7sr9MBid8juU8qaEkODZupnMeBSUQ2HMkxcRpLRi+Qrs8Vuj6AS1tqPj92h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.470.0/index.min.mjs": "sha384-z6MAK7sr9MBid8juU8qaEkODZupnMeBSUQ2HMkxcRpLRi+Qrs8Vuj6AS1tqPj92h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.470.0/LICENSE
```

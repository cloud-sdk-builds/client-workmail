...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pYJfzd/M/EUIb6IYN4QJRYMc1XIkfXTRizD8/N37bnv2CgKigIvoufHICXHV3vaP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.34.0/index.min.mjs": "sha384-pYJfzd/M/EUIb6IYN4QJRYMc1XIkfXTRizD8/N37bnv2CgKigIvoufHICXHV3vaP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.34.0/LICENSE
```

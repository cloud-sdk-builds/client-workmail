...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aJEFtjyw4jo72Se7xfPZmVZPw4x646LoxB+w717ouNsUwvRL/ObSIJaoNvUqPDp8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.734.0/index.min.mjs": "sha384-aJEFtjyw4jo72Se7xfPZmVZPw4x646LoxB+w717ouNsUwvRL/ObSIJaoNvUqPDp8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.734.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.895.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.895.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mlle1bmMzhVvPdUs0/wiy4IEs+cWcIyt0Iyp0uvK9DXXVV7AqU/GzsCLDpsMtqad
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.895.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.895.0/index.min.mjs": "sha384-mlle1bmMzhVvPdUs0/wiy4IEs+cWcIyt0Iyp0uvK9DXXVV7AqU/GzsCLDpsMtqad"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.895.0/LICENSE
```

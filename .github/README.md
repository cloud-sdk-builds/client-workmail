...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TfxEvJ5H+/FWgudlpF7b06aFMzRNR6Xat2KEMTFtsAZjfZjMzmgNakg/pWKXGHyk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.744.0/index.min.mjs": "sha384-TfxEvJ5H+/FWgudlpF7b06aFMzRNR6Xat2KEMTFtsAZjfZjMzmgNakg/pWKXGHyk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.744.0/LICENSE
```

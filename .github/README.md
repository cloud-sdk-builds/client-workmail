...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mlCsjx2C5xlJEuCw98O5ihknMTFiyE9D8sCTZAYkss9pwBPReHAa04ETejS3YTa0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.50.0/index.min.mjs": "sha384-mlCsjx2C5xlJEuCw98O5ihknMTFiyE9D8sCTZAYkss9pwBPReHAa04ETejS3YTa0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.50.0/LICENSE
```

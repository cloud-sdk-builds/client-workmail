...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wqwM8b4hbyT8Kq01wXoQ8DZLI4ZBafMns0QcbaTjihVfifmHVaiOUQeaWDo6QMva
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.395.0/index.min.mjs": "sha384-wqwM8b4hbyT8Kq01wXoQ8DZLI4ZBafMns0QcbaTjihVfifmHVaiOUQeaWDo6QMva"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.395.0/LICENSE
```

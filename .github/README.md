...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oI2yRLpVxB9LY7T/XdPTdIWCnj4LvKHGlCr5Yitj3qzXy7dpFFFWVoYmMp+albbI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.670.0/index.min.mjs": "sha384-oI2yRLpVxB9LY7T/XdPTdIWCnj4LvKHGlCr5Yitj3qzXy7dpFFFWVoYmMp+albbI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.670.0/LICENSE
```

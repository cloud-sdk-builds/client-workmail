...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pSCT3sa78lT0w/zE5KmKBIZqrmOd9xl+nbaqcdWRVy8bE4zWpcKDrC4dBkHUmGrv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.882.0/index.min.mjs": "sha384-pSCT3sa78lT0w/zE5KmKBIZqrmOd9xl+nbaqcdWRVy8bE4zWpcKDrC4dBkHUmGrv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.882.0/LICENSE
```

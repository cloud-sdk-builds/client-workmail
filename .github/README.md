...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/9v9Ybs8NANSpgQIMaI0DOTIfYEVKveJ46TCBX5JS2HA8XzcFXToCptKgLYLxbq0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.658.0/index.min.mjs": "sha384-/9v9Ybs8NANSpgQIMaI0DOTIfYEVKveJ46TCBX5JS2HA8XzcFXToCptKgLYLxbq0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.658.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ytjMBBk/ygmd/0oiKSzebwE2L+zEcFIQXlPWO7ZCiTxFtjn5GZBT6PU33HDbIIzK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.193.0/index.min.mjs": "sha384-ytjMBBk/ygmd/0oiKSzebwE2L+zEcFIQXlPWO7ZCiTxFtjn5GZBT6PU33HDbIIzK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.193.0/LICENSE
```

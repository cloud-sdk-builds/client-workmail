...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-EWPWUGFqdOxNCEon2CeWr2F3TW4ZY0c4+5sAtSXOZNiOtzfUoSmbfv37KOXFoN0S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.36.1/index.min.mjs": "sha384-EWPWUGFqdOxNCEon2CeWr2F3TW4ZY0c4+5sAtSXOZNiOtzfUoSmbfv37KOXFoN0S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.36.1/LICENSE
```

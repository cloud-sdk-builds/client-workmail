...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.969.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.969.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MGI2EUNyRmxApY/UYYE7QPvwWj8igSsBQjLBM2HtyivTsVs5SeKJv8rLTTv1mwdQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.969.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.969.0/index.min.mjs": "sha384-MGI2EUNyRmxApY/UYYE7QPvwWj8igSsBQjLBM2HtyivTsVs5SeKJv8rLTTv1mwdQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.969.0/LICENSE
```

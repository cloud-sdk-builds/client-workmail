...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JzoHoWzpuMvZiFrZGsZYNr1BvL653rWK1jH5Z16uWJer1YdZHFxB4tmsjfAF46uI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.932.0/index.min.mjs": "sha384-JzoHoWzpuMvZiFrZGsZYNr1BvL653rWK1jH5Z16uWJer1YdZHFxB4tmsjfAF46uI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.932.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/CW2GyKvidfd91Wo7nEHMMxog5cOUMdpQc3gYiVuvsu+2BKeSPfLEKkf1Jbuxs+Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.980.0/index.min.mjs": "sha384-/CW2GyKvidfd91Wo7nEHMMxog5cOUMdpQc3gYiVuvsu+2BKeSPfLEKkf1Jbuxs+Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.980.0/LICENSE
```

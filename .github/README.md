...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZyaBduBq0XhW7Rm8iNoYJdGu+TbdtK/LPXYiBRAYhMOBVg0/RM9Dy2iNRvg4Zdno
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.192.0/index.min.mjs": "sha384-ZyaBduBq0XhW7Rm8iNoYJdGu+TbdtK/LPXYiBRAYhMOBVg0/RM9Dy2iNRvg4Zdno"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.192.0/LICENSE
```

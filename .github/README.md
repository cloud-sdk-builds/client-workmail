...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xAnbym5hVXCkvMQVx3GW0zFIAMwke8MEUrnjrFfDs6qhBAKYzcSMKupyi8qCZjpR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.750.0/index.min.mjs": "sha384-xAnbym5hVXCkvMQVx3GW0zFIAMwke8MEUrnjrFfDs6qhBAKYzcSMKupyi8qCZjpR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.750.0/LICENSE
```

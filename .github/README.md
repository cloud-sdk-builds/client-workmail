...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v8d7OyvbCs3diUWc/X3UmZ1ZWEKWUmWguMXgj/0OZicmkP5nDcNh8Pn0gkeqn7SL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.568.0/index.min.mjs": "sha384-v8d7OyvbCs3diUWc/X3UmZ1ZWEKWUmWguMXgj/0OZicmkP5nDcNh8Pn0gkeqn7SL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.568.0/LICENSE
```

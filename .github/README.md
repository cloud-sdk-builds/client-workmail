...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RlwdnrMmG8yOFDErYJDq8dwO5oXZv0n4IozO8+9LKx2ig6Qp0mmR11tnlTL6rZ+v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.772.0/index.min.mjs": "sha384-RlwdnrMmG8yOFDErYJDq8dwO5oXZv0n4IozO8+9LKx2ig6Qp0mmR11tnlTL6rZ+v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.772.0/LICENSE
```

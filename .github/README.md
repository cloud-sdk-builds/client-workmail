...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.635.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.635.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gOeyorJ42tKcFcMuQxW8JTHAsaRSL34zUo7ryZ9rHxDS5gt27TCvjP8ssHpGyHYA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.635.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.635.0/index.min.mjs": "sha384-gOeyorJ42tKcFcMuQxW8JTHAsaRSL34zUo7ryZ9rHxDS5gt27TCvjP8ssHpGyHYA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.635.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1035.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1035.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/lKAt1cBMSQH9l2J40wLBhPkcT+pLQlX5UxSyASxOwxVZjGuzpIdetGC8pyMu4HS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1035.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1035.0/index.min.mjs": "sha384-/lKAt1cBMSQH9l2J40wLBhPkcT+pLQlX5UxSyASxOwxVZjGuzpIdetGC8pyMu4HS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1035.0/LICENSE
```

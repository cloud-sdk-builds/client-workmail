...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kayIyl0+6d4EHG+Z72c3mUNYPVnxPTdqOWxHlaS6cSJfHiCuDVmuwCaR3psJRr5l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.32.0/index.min.mjs": "sha384-kayIyl0+6d4EHG+Z72c3mUNYPVnxPTdqOWxHlaS6cSJfHiCuDVmuwCaR3psJRr5l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.32.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tmL0flHbchIdd4eXX0esP1cuh2DOE+hD+lAqOJpah03Mk35SqPD7RfW4SSl+Jyyr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.345.0/index.min.mjs": "sha384-tmL0flHbchIdd4eXX0esP1cuh2DOE+hD+lAqOJpah03Mk35SqPD7RfW4SSl+Jyyr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.345.0/LICENSE
```

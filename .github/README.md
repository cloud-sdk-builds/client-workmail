...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vuHZWQwW+T43Kfv0yTv/E8y2dapdAkrntSy8FBd3u9Z6q4zmVCvhoXNr+kGfcIkK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.271.0/index.min.mjs": "sha384-vuHZWQwW+T43Kfv0yTv/E8y2dapdAkrntSy8FBd3u9Z6q4zmVCvhoXNr+kGfcIkK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.271.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.169.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.169.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zo+svPUFYmquEB56j7LOjr3baiWLya/1x8Y9IBCP7jACAnnAGgs5u3hsURFVOXoy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.169.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.169.0/index.min.mjs": "sha384-Zo+svPUFYmquEB56j7LOjr3baiWLya/1x8Y9IBCP7jACAnnAGgs5u3hsURFVOXoy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.169.0/LICENSE
```

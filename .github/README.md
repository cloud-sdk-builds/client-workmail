...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.414.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.414.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-giTk3Q5em1cx7XWXZaXrcqyt9SmfAKNYzxiZnrTcSuxhSHNTtFr9hdYeZ+F4fjdr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.414.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.414.0/index.min.mjs": "sha384-giTk3Q5em1cx7XWXZaXrcqyt9SmfAKNYzxiZnrTcSuxhSHNTtFr9hdYeZ+F4fjdr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.414.0/LICENSE
```

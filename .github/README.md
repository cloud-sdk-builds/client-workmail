...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-5WsD9pB+EpKYl+Dp7yIvgzURIZkZU9OD4hyZLaeg+WhzGTqh7RaDayRcHsC7AcvR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.54.1/index.min.mjs": "sha384-5WsD9pB+EpKYl+Dp7yIvgzURIZkZU9OD4hyZLaeg+WhzGTqh7RaDayRcHsC7AcvR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.54.1/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1028.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1028.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WKmYgGn44vxzvERajmxkb9ifLGRcFbsW8+oOts44Ruvq8jA+xHja4ZstDi88SwHO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1028.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1028.0/index.min.mjs": "sha384-WKmYgGn44vxzvERajmxkb9ifLGRcFbsW8+oOts44Ruvq8jA+xHja4ZstDi88SwHO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1028.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oIYbMpmGsHO4c/wCt0IQmZHHYKefrHq2OvgshKXclpOmU+OJ7t9aMPq90wBpaYYP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.154.0/index.min.mjs": "sha384-oIYbMpmGsHO4c/wCt0IQmZHHYKefrHq2OvgshKXclpOmU+OJ7t9aMPq90wBpaYYP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.154.0/LICENSE
```

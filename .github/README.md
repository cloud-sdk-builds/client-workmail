...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HzPHl3vgzTgUh6nZWTczzcn4p/r7/wL8YN4UZOlafrzv7Els+JzYdzcivXMebvG4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.896.0/index.min.mjs": "sha384-HzPHl3vgzTgUh6nZWTczzcn4p/r7/wL8YN4UZOlafrzv7Els+JzYdzcivXMebvG4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.896.0/LICENSE
```

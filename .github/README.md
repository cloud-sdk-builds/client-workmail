...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-awyK+IQvYJf3Cgy5JcnM2b4eTcqbOD6ODHb5idH/aTGuoBFlLI3s9o7JrzfqcfXW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.935.0/index.min.mjs": "sha384-awyK+IQvYJf3Cgy5JcnM2b4eTcqbOD6ODHb5idH/aTGuoBFlLI3s9o7JrzfqcfXW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.935.0/LICENSE
```

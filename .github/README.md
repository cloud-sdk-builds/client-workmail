...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iwJzyIJB9JiHvkvwGRfKGEXs8pHSWLac9m9Lbcp+S9RnhTFeQOwKPkqtEGb0RXOr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.183.0/index.min.mjs": "sha384-iwJzyIJB9JiHvkvwGRfKGEXs8pHSWLac9m9Lbcp+S9RnhTFeQOwKPkqtEGb0RXOr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.183.0/LICENSE
```

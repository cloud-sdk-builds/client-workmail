...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jRGggkL1FN1dIkkVpZlnloz83GxTZzUv4JM5EMHXmz65LR5ibPrRta5Aa1ED0C2I
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.474.0/index.min.mjs": "sha384-jRGggkL1FN1dIkkVpZlnloz83GxTZzUv4JM5EMHXmz65LR5ibPrRta5Aa1ED0C2I"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.474.0/LICENSE
```

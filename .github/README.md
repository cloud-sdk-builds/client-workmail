...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xrq7HSl8xY3G3CyWEuujwffOIldDcaLl6tE1lvPu68m0ZxW3f02THl6dticnzJcS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.296.0/index.min.mjs": "sha384-xrq7HSl8xY3G3CyWEuujwffOIldDcaLl6tE1lvPu68m0ZxW3f02THl6dticnzJcS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.296.0/LICENSE
```

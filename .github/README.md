...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.199.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.199.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jZxWedyH4jEXKtdVUV02U0yexPEPan1KR0pKNs8uHHJ05jg7S8fsUVibVDAUw56k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.199.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.199.0/index.min.mjs": "sha384-jZxWedyH4jEXKtdVUV02U0yexPEPan1KR0pKNs8uHHJ05jg7S8fsUVibVDAUw56k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.199.0/LICENSE
```

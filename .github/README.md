...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1022.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1022.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2buW0s9K2TfnkGN3Bb84Pg6ZtVyjXZf4j8XKBgGoPSiNxA4z2g2ezE1jMeTSaxTV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1022.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1022.0/index.min.mjs": "sha384-2buW0s9K2TfnkGN3Bb84Pg6ZtVyjXZf4j8XKBgGoPSiNxA4z2g2ezE1jMeTSaxTV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1022.0/LICENSE
```

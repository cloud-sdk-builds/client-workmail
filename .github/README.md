...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KyfMx5wcS6J9d1VzatnzMl3saOuyI2nvkErMOxLc0tl7BTgOSME4Ryf1O5Z6C7+V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.130.0/index.min.mjs": "sha384-KyfMx5wcS6J9d1VzatnzMl3saOuyI2nvkErMOxLc0tl7BTgOSME4Ryf1O5Z6C7+V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.130.0/LICENSE
```

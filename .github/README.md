...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1030.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1030.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p3gkoeRnL369tkh4IknNH69uC1SkrBSZ4x/4OXzvjwVKeBRs2B+Bm5xfcDlKa6ht
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1030.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1030.0/index.min.mjs": "sha384-p3gkoeRnL369tkh4IknNH69uC1SkrBSZ4x/4OXzvjwVKeBRs2B+Bm5xfcDlKa6ht"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1030.0/LICENSE
```

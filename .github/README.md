...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.490.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.490.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IMn3e2EFfj0uGGtsDAmNxwZ8DMjsptMVTqfvcrp1mmhdqC9Dol6VMl2UWNdxs2MB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.490.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.490.0/index.min.mjs": "sha384-IMn3e2EFfj0uGGtsDAmNxwZ8DMjsptMVTqfvcrp1mmhdqC9Dol6VMl2UWNdxs2MB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.490.0/LICENSE
```

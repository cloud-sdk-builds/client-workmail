...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.511.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.511.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iy6TagDVcGfYXtq8Ms49xqCmluNbyaYytnCW+q2VKt1xsEX+kGnTzDAygvPkf9bU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.511.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.511.0/index.min.mjs": "sha384-iy6TagDVcGfYXtq8Ms49xqCmluNbyaYytnCW+q2VKt1xsEX+kGnTzDAygvPkf9bU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.511.0/LICENSE
```

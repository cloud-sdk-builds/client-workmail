...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FvAua/TeqyfleKmTX2c3AhE8kBkXXd7SK2vEn11QlQ4UVoBXuNcPvE9P1GdtYhaD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.299.0/index.min.mjs": "sha384-FvAua/TeqyfleKmTX2c3AhE8kBkXXd7SK2vEn11QlQ4UVoBXuNcPvE9P1GdtYhaD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.299.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p6ajOfYTVxLjQym4h1jBrurMNe0bXdz6oaqEfYR1mJiO9xvL5m+yY4mRSoHag7gy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.298.0/index.min.mjs": "sha384-p6ajOfYTVxLjQym4h1jBrurMNe0bXdz6oaqEfYR1mJiO9xvL5m+yY4mRSoHag7gy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.298.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F3gtwUNQSNrOa6H4MESpRuoIbGjfyiuNZpI5JLqCZ6ORjyWTvAl9AMNpkxJELB6R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.121.0/index.min.mjs": "sha384-F3gtwUNQSNrOa6H4MESpRuoIbGjfyiuNZpI5JLqCZ6ORjyWTvAl9AMNpkxJELB6R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.121.0/LICENSE
```

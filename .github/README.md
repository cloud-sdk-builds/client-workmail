...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wxYeFjEYA4vdneVZnSkRhoU4VnqkE7pfQbEAcuIYrkXb5UCBwuheJTlGFIrD4YNW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.582.0/index.min.mjs": "sha384-wxYeFjEYA4vdneVZnSkRhoU4VnqkE7pfQbEAcuIYrkXb5UCBwuheJTlGFIrD4YNW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.582.0/LICENSE
```

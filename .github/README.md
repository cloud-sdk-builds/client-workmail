...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oHn5dRLgNhw1akN+7cxyyr76gwNd0gRfd6aHJeQB0pp7tbls4VH/9sOd4sfukqN7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.478.0/index.min.mjs": "sha384-oHn5dRLgNhw1akN+7cxyyr76gwNd0gRfd6aHJeQB0pp7tbls4VH/9sOd4sfukqN7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.478.0/LICENSE
```

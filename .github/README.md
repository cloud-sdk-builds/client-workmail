...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1044.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1044.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j9LwBYiJnMBaeBNDBzGq3gUbDVz/qT8frqzdM9/3fBURTaP93FvW4s3EY1uQS+PE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1044.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1044.0/index.min.mjs": "sha384-j9LwBYiJnMBaeBNDBzGq3gUbDVz/qT8frqzdM9/3fBURTaP93FvW4s3EY1uQS+PE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1044.0/LICENSE
```

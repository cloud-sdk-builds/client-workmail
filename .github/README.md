...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oWw6kfCOvaD6ODPxnYQi8l/1sGPslkgimos9v3BRDnIHEYY5YG8J4dMmB2vGDeHj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.329.0/index.min.mjs": "sha384-oWw6kfCOvaD6ODPxnYQi8l/1sGPslkgimos9v3BRDnIHEYY5YG8J4dMmB2vGDeHj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.329.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Fdah3rE75trqoW3rXO7IGnTfWRS+xhE0DUa4xpPOaeEE5/v790jjUMTPkinD76rf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.730.0/index.min.mjs": "sha384-Fdah3rE75trqoW3rXO7IGnTfWRS+xhE0DUa4xpPOaeEE5/v790jjUMTPkinD76rf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.730.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oipObEm4XqVUQQZWmm3H+x5W8LoiglQGCatzbiDxkY2VbTguSMMry8iwjs8ttCma
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.993.0/index.min.mjs": "sha384-oipObEm4XqVUQQZWmm3H+x5W8LoiglQGCatzbiDxkY2VbTguSMMry8iwjs8ttCma"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.993.0/LICENSE
```

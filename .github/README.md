...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6P+1ZPsjn0KiD2xycRQynQxmb5i1+lv9plv/WliTHy/mf9Q3fGX7Oh117KNki9q9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.362.0/index.min.mjs": "sha384-6P+1ZPsjn0KiD2xycRQynQxmb5i1+lv9plv/WliTHy/mf9Q3fGX7Oh117KNki9q9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.362.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.8.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.8.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TpScKb8JGgG61cJAIihqSAg1qrZ6vA350m099sOW2spNF9p1FwEY9bSJ1BNUGPTw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.8.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.8.0/index.min.mjs": "sha384-TpScKb8JGgG61cJAIihqSAg1qrZ6vA350m099sOW2spNF9p1FwEY9bSJ1BNUGPTw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.8.0/LICENSE
```

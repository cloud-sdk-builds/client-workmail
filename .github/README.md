...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.501.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.501.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N9iIHL+MO2tIGPhLahhkZhPvTuH3y4rc5RU3C7SN3iwf3HEyvisLBnZE81znU4gW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.501.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.501.0/index.min.mjs": "sha384-N9iIHL+MO2tIGPhLahhkZhPvTuH3y4rc5RU3C7SN3iwf3HEyvisLBnZE81znU4gW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.501.0/LICENSE
```

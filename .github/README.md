...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.910.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.910.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gAqLRPpE93tvCguFx0jzE81S6EVYy3DVEuN8XXCMk8AcJ2tWAxMrHXlIx22KiD93
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.910.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.910.0/index.min.mjs": "sha384-gAqLRPpE93tvCguFx0jzE81S6EVYy3DVEuN8XXCMk8AcJ2tWAxMrHXlIx22KiD93"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.910.0/LICENSE
```

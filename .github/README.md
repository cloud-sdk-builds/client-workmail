...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1025.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1025.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DJr/jABqA1m2QhOPPOgZhgDI8dibzZDqZFIFihb6pStuovsXYm8LFKxHS06Z+59V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1025.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1025.0/index.min.mjs": "sha384-DJr/jABqA1m2QhOPPOgZhgDI8dibzZDqZFIFihb6pStuovsXYm8LFKxHS06Z+59V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1025.0/LICENSE
```

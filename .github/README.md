...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.210.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.210.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GAzwRwxSEYTfExVInb3GVXJ0TApFri9KX0M9CjoqbhdFdz2pfyjZuLdjNtshbN7G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.210.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.210.0/index.min.mjs": "sha384-GAzwRwxSEYTfExVInb3GVXJ0TApFri9KX0M9CjoqbhdFdz2pfyjZuLdjNtshbN7G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.210.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YiIkz9prLGsTzyT0NpinD9DddVIN2G+fBKElV0F1BUyPr2IvFaZBGVQx0oOzJxpp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.844.0/index.min.mjs": "sha384-YiIkz9prLGsTzyT0NpinD9DddVIN2G+fBKElV0F1BUyPr2IvFaZBGVQx0oOzJxpp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.844.0/LICENSE
```

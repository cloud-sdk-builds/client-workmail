...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.575.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.575.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mZTU4IUiTfs8nGi5npAxeajffqdy6PRIOZ9lEtqJyKCeHWrpXN3FlDJc3mmyuqEM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.575.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.575.0/index.min.mjs": "sha384-mZTU4IUiTfs8nGi5npAxeajffqdy6PRIOZ9lEtqJyKCeHWrpXN3FlDJc3mmyuqEM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.575.0/LICENSE
```

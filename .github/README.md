...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.55.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.55.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qng6aSy6/Ik9ZbvsJSeCksbU9nNZOUMqOCU5GIxm6g35sd1EfplFT7H+Ms9w9xNk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.55.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.55.0/index.min.mjs": "sha384-Qng6aSy6/Ik9ZbvsJSeCksbU9nNZOUMqOCU5GIxm6g35sd1EfplFT7H+Ms9w9xNk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.55.0/LICENSE
```

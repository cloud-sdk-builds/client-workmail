...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/Idra3IEOJbsB/VS8fFxezSD7WE3kjakfYLTKKLODhnRnL4FOZ73da6v7KHwyGmA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.982.0/index.min.mjs": "sha384-/Idra3IEOJbsB/VS8fFxezSD7WE3kjakfYLTKKLODhnRnL4FOZ73da6v7KHwyGmA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.982.0/LICENSE
```

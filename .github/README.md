...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Y7409Rl37psAw0gUSZ7B4B4ZisWpB4NKkJm3y3Gmy4fEN1Zq/sQ2ILXTwAJWc3CQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.300.0/index.min.mjs": "sha384-Y7409Rl37psAw0gUSZ7B4B4ZisWpB4NKkJm3y3Gmy4fEN1Zq/sQ2ILXTwAJWc3CQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.300.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.287.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.287.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hUIVa9oWk0Qre+YD5fA+27kqeN7k0X7zjIKVEe9GTbLqWZ+TedEQU4FV1TFKpoSo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.287.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.287.0/index.min.mjs": "sha384-hUIVa9oWk0Qre+YD5fA+27kqeN7k0X7zjIKVEe9GTbLqWZ+TedEQU4FV1TFKpoSo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.287.0/LICENSE
```

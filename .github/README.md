...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kI1XwuzMoZJKkzEd9Y9a9tzucdkHV5Axdsx+gkGF+hk3hEcNcYbesbN1ZktJFS7O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.947.0/index.min.mjs": "sha384-kI1XwuzMoZJKkzEd9Y9a9tzucdkHV5Axdsx+gkGF+hk3hEcNcYbesbN1ZktJFS7O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.947.0/LICENSE
```

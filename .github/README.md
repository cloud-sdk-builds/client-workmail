...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XV3PHOuM/Wtnx2L815Nn35GOvZSHylEc5Wt3zYvUzM9ydYxad/fziui0EOAeED73
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.222.0/index.min.mjs": "sha384-XV3PHOuM/Wtnx2L815Nn35GOvZSHylEc5Wt3zYvUzM9ydYxad/fziui0EOAeED73"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.222.0/LICENSE
```

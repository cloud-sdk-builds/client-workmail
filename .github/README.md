...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bpgWcCA2wv5hyGdOC5Mv5JqlnYoZ2KhEBBcNVHW69xZAdTF1oi67pGq82FuqePzg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.319.0/index.min.mjs": "sha384-bpgWcCA2wv5hyGdOC5Mv5JqlnYoZ2KhEBBcNVHW69xZAdTF1oi67pGq82FuqePzg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.319.0/LICENSE
```

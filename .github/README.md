...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-o6ZQFCXg7Av0HcMeTOeUmycAnsWjE0dVPca1Hl3b5y6tmOqhNFQ058Q49o2JO5rb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.72.0/index.min.mjs": "sha384-o6ZQFCXg7Av0HcMeTOeUmycAnsWjE0dVPca1Hl3b5y6tmOqhNFQ058Q49o2JO5rb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.72.0/LICENSE
```

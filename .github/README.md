...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uFgaQ0PNhimKZbw0nfM7DdSSL2ZRmDBg2BnKZmbYmmrQAv7qbwJ5PG6QhTAwEotW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.388.0/index.min.mjs": "sha384-uFgaQ0PNhimKZbw0nfM7DdSSL2ZRmDBg2BnKZmbYmmrQAv7qbwJ5PG6QhTAwEotW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.388.0/LICENSE
```

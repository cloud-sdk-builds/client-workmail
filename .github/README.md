...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xce+2ndRG2lxZtL8aGHs/x6xheWPAFCYvP+nqwavO3Ym7mbfKf2k/JbJbWH7E0dN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.226.0/index.min.mjs": "sha384-Xce+2ndRG2lxZtL8aGHs/x6xheWPAFCYvP+nqwavO3Ym7mbfKf2k/JbJbWH7E0dN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.226.0/LICENSE
```

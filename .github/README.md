...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SF6v1WoH8Jl/3A8xefr12K6qQqAxlYdl83yXOf1WfFKlRP6nJcgd50Dry4uFWdUg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.0.0/index.min.mjs": "sha384-SF6v1WoH8Jl/3A8xefr12K6qQqAxlYdl83yXOf1WfFKlRP6nJcgd50Dry4uFWdUg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.0.0/LICENSE
```

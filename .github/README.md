...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8GvQt0dCVs5qbwpdeX7cmyI8ZJymN9yu+3v4h1ZNKsJjjD+q1s7O6rdhb2pJe1jO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.714.0/index.min.mjs": "sha384-8GvQt0dCVs5qbwpdeX7cmyI8ZJymN9yu+3v4h1ZNKsJjjD+q1s7O6rdhb2pJe1jO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.714.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AQ9ggb4CiJfQp54QxWbWgfQ8G5ES23cPxZ3PWonc337cj17+XXcre19/qoXCrqRo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.200.0/index.min.mjs": "sha384-AQ9ggb4CiJfQp54QxWbWgfQ8G5ES23cPxZ3PWonc337cj17+XXcre19/qoXCrqRo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.200.0/LICENSE
```

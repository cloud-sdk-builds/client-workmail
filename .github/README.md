...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1033.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1033.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u3D4NjQ6e10xwy5Cs+xikT0KaVwHZIGXdOXLAwNLb0PU/ZYTMMoNjjL/NeoBKNSu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1033.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1033.0/index.min.mjs": "sha384-u3D4NjQ6e10xwy5Cs+xikT0KaVwHZIGXdOXLAwNLb0PU/ZYTMMoNjjL/NeoBKNSu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1033.0/LICENSE
```

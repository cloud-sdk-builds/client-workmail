...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-77y2kiU4/xSsFMB046lTUtx5vT2zwPtwwZqwkzFb/hmFg3+cllt6Cg+oIIb8WmGQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.118.0/index.min.mjs": "sha384-77y2kiU4/xSsFMB046lTUtx5vT2zwPtwwZqwkzFb/hmFg3+cllt6Cg+oIIb8WmGQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.118.0/LICENSE
```

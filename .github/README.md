...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oERl9xb0mnBVe+q0bVs4Je4bHm+rKWNNzO7i8wbQjoMkByWE3vlrvtyZSHmLpaZ5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.598.0/index.min.mjs": "sha384-oERl9xb0mnBVe+q0bVs4Je4bHm+rKWNNzO7i8wbQjoMkByWE3vlrvtyZSHmLpaZ5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.598.0/LICENSE
```

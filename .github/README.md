...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vOyJ9mne1fHwJAIPlCyp6u1NWiKwD+pyZsVKkMkVtOWGRacEeXeIjtmDwny0Hw2x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.35.0/index.min.mjs": "sha384-vOyJ9mne1fHwJAIPlCyp6u1NWiKwD+pyZsVKkMkVtOWGRacEeXeIjtmDwny0Hw2x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.35.0/LICENSE
```

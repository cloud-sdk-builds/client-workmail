...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tJOWxYXhn8iZKYgl8gODRUop3L2v3AemieebuDhsuzBb8hm5js0fVb7tOFKYIygb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.913.0/index.min.mjs": "sha384-tJOWxYXhn8iZKYgl8gODRUop3L2v3AemieebuDhsuzBb8hm5js0fVb7tOFKYIygb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.913.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lGQMxAugPAbCyGLteMC2EdHOxIKl2VeY459HIXWAZSeaWqwh7v4+g1aZx4ciJH/0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.216.0/index.min.mjs": "sha384-lGQMxAugPAbCyGLteMC2EdHOxIKl2VeY459HIXWAZSeaWqwh7v4+g1aZx4ciJH/0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.216.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AfmoYGyv/lAus14FP5iU8JBmMKLsZRKO9a/JMwqA1ewfPSuuZHuidejrGTmQ3Rph
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.16.0/index.min.mjs": "sha384-AfmoYGyv/lAus14FP5iU8JBmMKLsZRKO9a/JMwqA1ewfPSuuZHuidejrGTmQ3Rph"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.16.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KodAx94ASknGi5CHTjohteHWAkioSpEuNFlfLM8cxABt0EJds+MGFpR6mP2fVORP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.312.0/index.min.mjs": "sha384-KodAx94ASknGi5CHTjohteHWAkioSpEuNFlfLM8cxABt0EJds+MGFpR6mP2fVORP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.312.0/LICENSE
```

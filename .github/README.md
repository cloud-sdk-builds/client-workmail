...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.204.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.204.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fOXbcZ0wSzkkg581XhYnciWwbmg7M/7ihHR1CNma0YZl98nKwh7V+RCZ+a+xeib3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.204.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.204.0/index.min.mjs": "sha384-fOXbcZ0wSzkkg581XhYnciWwbmg7M/7ihHR1CNma0YZl98nKwh7V+RCZ+a+xeib3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.204.0/LICENSE
```

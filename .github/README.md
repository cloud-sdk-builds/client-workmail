...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sTRhe5U/SNhGhfrqyZEXBbV84bTwMmS8W1BGcdPPpQ8KAAoqLPZR7iQ3dFJ5N2Eo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.823.0/index.min.mjs": "sha384-sTRhe5U/SNhGhfrqyZEXBbV84bTwMmS8W1BGcdPPpQ8KAAoqLPZR7iQ3dFJ5N2Eo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.823.0/LICENSE
```

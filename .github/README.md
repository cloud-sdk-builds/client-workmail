...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dUHil5gnw+kGf+smrilLuYsxNXNDjm2X9Cnvgnf9NvYZtjMKuJ5WBW9y91Bi1zTM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.624.0/index.min.mjs": "sha384-dUHil5gnw+kGf+smrilLuYsxNXNDjm2X9Cnvgnf9NvYZtjMKuJ5WBW9y91Bi1zTM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.624.0/LICENSE
```

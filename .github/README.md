...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.30.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.30.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gha3nIblIwLOb9K2rck50xLzASQUIOwGhHDADYhXQNA19rWOLO/m3+YAE3d6CZwv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.30.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.30.0/index.min.mjs": "sha384-Gha3nIblIwLOb9K2rck50xLzASQUIOwGhHDADYhXQNA19rWOLO/m3+YAE3d6CZwv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.30.0/LICENSE
```

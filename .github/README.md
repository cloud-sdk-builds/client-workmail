...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EKJyDkeV4MP3J4f2d+cEBWMaxhhtCPxtfT6e9wGMivILoBcxdwNWWtP7qO0HfWeU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.677.0/index.min.mjs": "sha384-EKJyDkeV4MP3J4f2d+cEBWMaxhhtCPxtfT6e9wGMivILoBcxdwNWWtP7qO0HfWeU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.677.0/LICENSE
```

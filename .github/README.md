...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.458.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.458.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1eVD6f9LIHArC+pS64NdafxOvEV9CF14QY2ClZ+4olwVoVTfpCn6MKH8XuM2p1SE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.458.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.458.0/index.min.mjs": "sha384-1eVD6f9LIHArC+pS64NdafxOvEV9CF14QY2ClZ+4olwVoVTfpCn6MKH8XuM2p1SE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.458.0/LICENSE
```

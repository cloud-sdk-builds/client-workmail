...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ThaW8mpANwumaqZwlnDXce6HgL0WRDe+EMEMiDd2If1M7xfkvowdyOGeicc+oVL1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.293.0/index.min.mjs": "sha384-ThaW8mpANwumaqZwlnDXce6HgL0WRDe+EMEMiDd2If1M7xfkvowdyOGeicc+oVL1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.293.0/LICENSE
```

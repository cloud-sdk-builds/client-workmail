...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F65N1mrm/on1USrcshvOT70vbqG0pOlIemxjTRkGyvmXtCbggwXB/Lbeu6vA0LOC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.254.0/index.min.mjs": "sha384-F65N1mrm/on1USrcshvOT70vbqG0pOlIemxjTRkGyvmXtCbggwXB/Lbeu6vA0LOC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.254.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CcE1BxbVjyA716wVnhGTyWF1P9ZinmjvHUKzQ71t7N9byLvcXfl48BqjKJumcNJ0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.948.0/index.min.mjs": "sha384-CcE1BxbVjyA716wVnhGTyWF1P9ZinmjvHUKzQ71t7N9byLvcXfl48BqjKJumcNJ0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.948.0/LICENSE
```

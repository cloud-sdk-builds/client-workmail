...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.179.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.179.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EZu/qUoIOOJbcRF5EjovWKlqBkpmseUI47A7dhJ97fesgvIQlB9o46O7jk7lZF93
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.179.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.179.0/index.min.mjs": "sha384-EZu/qUoIOOJbcRF5EjovWKlqBkpmseUI47A7dhJ97fesgvIQlB9o46O7jk7lZF93"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.179.0/LICENSE
```

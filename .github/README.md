...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0EEHUtPNqZS9UKJJTcqbVkPrzw0iS7lnt5J/h9ZiYl+sXuUw0f5rNJjssA4Aqf/2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.26.0/index.min.mjs": "sha384-0EEHUtPNqZS9UKJJTcqbVkPrzw0iS7lnt5J/h9ZiYl+sXuUw0f5rNJjssA4Aqf/2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.26.0/LICENSE
```

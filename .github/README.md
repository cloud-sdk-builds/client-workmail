...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XHva7cYwkRVi/5Dw9klM71w6FK9tpDZXeuZXUMghnZApZ1Bpa2osBYdY2s0JwCxH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.592.0/index.min.mjs": "sha384-XHva7cYwkRVi/5Dw9klM71w6FK9tpDZXeuZXUMghnZApZ1Bpa2osBYdY2s0JwCxH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.592.0/LICENSE
```

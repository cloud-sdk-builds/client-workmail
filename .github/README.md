...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p7YHoFpu4x6iTY9Svgo0iZImweMUoW9ZZdsY9+9DHkMSeb59bs8jyEDlmpUZSJz1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.576.0/index.min.mjs": "sha384-p7YHoFpu4x6iTY9Svgo0iZImweMUoW9ZZdsY9+9DHkMSeb59bs8jyEDlmpUZSJz1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.576.0/LICENSE
```

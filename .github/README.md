...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N+JMh1L8MkwBIDOo07t6BAAcjEgaa2igBaRPM84hNE5ua4oD91YWCtYUr4vAFqdg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.197.0/index.min.mjs": "sha384-N+JMh1L8MkwBIDOo07t6BAAcjEgaa2igBaRPM84hNE5ua4oD91YWCtYUr4vAFqdg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.197.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O/coYYA2CsEdCvRh0OEOPtoI3F1vsI7gYC/59JG9dGLx8GxbN5vSgjxoPiYWqtAL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.726.0/index.min.mjs": "sha384-O/coYYA2CsEdCvRh0OEOPtoI3F1vsI7gYC/59JG9dGLx8GxbN5vSgjxoPiYWqtAL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.726.0/LICENSE
```

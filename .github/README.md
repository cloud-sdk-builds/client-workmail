...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.803.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.803.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7+KEfVaVryXXMJ6CipckPAG3zycXsQzX3iE0/GRZDJamqNx3WrW5FEUP/vYBhOnl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.803.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.803.0/index.min.mjs": "sha384-7+KEfVaVryXXMJ6CipckPAG3zycXsQzX3iE0/GRZDJamqNx3WrW5FEUP/vYBhOnl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.803.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GHTVZ7m8rLkbVp4vzBLouiys3N6/yVuzw69qzpMvGswjAry1kRrX44o7gHumAzVl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.918.0/index.min.mjs": "sha384-GHTVZ7m8rLkbVp4vzBLouiys3N6/yVuzw69qzpMvGswjAry1kRrX44o7gHumAzVl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.918.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bavQS47RUOTI74Ed+KcZmS7qoe2Of0HiNIrr4uZW74lJCUiD5o5OVgOCw2Jn+MC/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.654.0/index.min.mjs": "sha384-bavQS47RUOTI74Ed+KcZmS7qoe2Of0HiNIrr4uZW74lJCUiD5o5OVgOCw2Jn+MC/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.654.0/LICENSE
```

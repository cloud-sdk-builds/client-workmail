...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.23.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.23.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oVuu9Gxs/MDXO2cXAOZ6plQbz5gKUiOvVdBkK5pV8SMyVc8S1ojyNfwpJOJh6RhZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.23.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.23.0/index.min.mjs": "sha384-oVuu9Gxs/MDXO2cXAOZ6plQbz5gKUiOvVdBkK5pV8SMyVc8S1ojyNfwpJOJh6RhZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.23.0/LICENSE
```

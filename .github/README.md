...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NFhgOyg96CgiZtNYpyQG7jjnRKl70appsq7BaZDF82qrgHjFCa5M9YpKWyR73gOD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.916.0/index.min.mjs": "sha384-NFhgOyg96CgiZtNYpyQG7jjnRKl70appsq7BaZDF82qrgHjFCa5M9YpKWyR73gOD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.916.0/LICENSE
```

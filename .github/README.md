...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d1TpqFxUcanjSsjB3cCH6iEWOWUAnSN0z1cyUllsErQpOcZjS5uzr2HMyPuLqmoh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.460.0/index.min.mjs": "sha384-d1TpqFxUcanjSsjB3cCH6iEWOWUAnSN0z1cyUllsErQpOcZjS5uzr2HMyPuLqmoh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.460.0/LICENSE
```

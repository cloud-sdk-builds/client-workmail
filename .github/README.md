...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ko2YtOW6cue/sWaehAF6Gn0CVSSHklyuftCgIB7gW57WYyA5pXUWf4FHHFtYsrLt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.37.0/index.min.mjs": "sha384-Ko2YtOW6cue/sWaehAF6Gn0CVSSHklyuftCgIB7gW57WYyA5pXUWf4FHHFtYsrLt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.37.0/LICENSE
```

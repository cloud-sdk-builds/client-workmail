...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lOTa5o+kmUWc/h9fmQ+AvLaPppQo9yjqegO3tYs6nlC7GVbE+58cLZIISDNWJ7YM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.316.0/index.min.mjs": "sha384-lOTa5o+kmUWc/h9fmQ+AvLaPppQo9yjqegO3tYs6nlC7GVbE+58cLZIISDNWJ7YM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.316.0/LICENSE
```

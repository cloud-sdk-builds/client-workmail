...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.31.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.31.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rcYETl0yGDOz6UvlGsDIfDf2QGYPJMK4adhZDuVFKtPcMwuWpGcKoTjOAcW2emMl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.31.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.31.0/index.min.mjs": "sha384-rcYETl0yGDOz6UvlGsDIfDf2QGYPJMK4adhZDuVFKtPcMwuWpGcKoTjOAcW2emMl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.31.0/LICENSE
```

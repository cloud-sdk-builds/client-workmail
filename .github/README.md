...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SejVN4ZZfeWeZi0J+hOj/1oKMzHXrTecD7RSDE6DDLsMI8HBbMND14hKVtA9E7uD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.28.0/index.min.mjs": "sha384-SejVN4ZZfeWeZi0J+hOj/1oKMzHXrTecD7RSDE6DDLsMI8HBbMND14hKVtA9E7uD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.28.0/LICENSE
```

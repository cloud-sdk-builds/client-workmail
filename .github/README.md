...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FYWwbKGoIB3LeJrKNloigo17gQXBQxrAzc+eL4z9+by2HVe4bGuCoiOVwxRt7KQR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.332.0/index.min.mjs": "sha384-FYWwbKGoIB3LeJrKNloigo17gQXBQxrAzc+eL4z9+by2HVe4bGuCoiOVwxRt7KQR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.332.0/LICENSE
```

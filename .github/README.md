...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E9ODln+CqtSOC5IvIdeRA3yHS0rSrBkcV5RW1I6aaPIeXgmLidZqVU0DTSBvIb3k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.196.0/index.min.mjs": "sha384-E9ODln+CqtSOC5IvIdeRA3yHS0rSrBkcV5RW1I6aaPIeXgmLidZqVU0DTSBvIb3k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.196.0/LICENSE
```

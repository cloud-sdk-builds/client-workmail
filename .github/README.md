...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bnS6xd6GcbEoWRltYceIWqJ5p+9QGOM+R5zjXg8vCzZ3+A4LJUXdbgdAbZtZQ9c3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.40.0/index.min.mjs": "sha384-bnS6xd6GcbEoWRltYceIWqJ5p+9QGOM+R5zjXg8vCzZ3+A4LJUXdbgdAbZtZQ9c3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.40.0/LICENSE
```

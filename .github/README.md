...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HYCy9MXShdIf0IxLfg1y/mIqNC4x5YKKnpp4JncI+7LRk1nrtq83iM6D1J7XWngy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.886.0/index.min.mjs": "sha384-HYCy9MXShdIf0IxLfg1y/mIqNC4x5YKKnpp4JncI+7LRk1nrtq83iM6D1J7XWngy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.886.0/LICENSE
```

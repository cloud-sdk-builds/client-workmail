...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.6.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.6.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-aEfxnTqK1lBjblAsU3KMxbX9JwZXE1w2hqKIil/MYzNJyQMBO7SQ2KgsB6CFezFi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.6.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.6.1/index.min.mjs": "sha384-aEfxnTqK1lBjblAsU3KMxbX9JwZXE1w2hqKIil/MYzNJyQMBO7SQ2KgsB6CFezFi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.6.1/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mxypYxFBBmSzqzV9WnCK+1kakuKPXA0M2ETl8q7Oi/v2WD4M1yaExxKq42HdH129
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.723.0/index.min.mjs": "sha384-mxypYxFBBmSzqzV9WnCK+1kakuKPXA0M2ETl8q7Oi/v2WD4M1yaExxKq42HdH129"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.723.0/LICENSE
```

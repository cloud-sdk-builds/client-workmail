...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.344.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.344.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C0lEf9H0m/4LXO03r3rLtsdOhLi1sNcO6MTnCiRvVSL+RV8d+IgAw5DAQwjvVml2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.344.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.344.0/index.min.mjs": "sha384-C0lEf9H0m/4LXO03r3rLtsdOhLi1sNcO6MTnCiRvVSL+RV8d+IgAw5DAQwjvVml2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.344.0/LICENSE
```

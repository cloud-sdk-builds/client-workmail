...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7u1wA+HTsU4x9MUZHHHJ5ixSwhn2ZuigGKMhpNITH3jZYIumwDxfJtCduBj6wa2Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.503.0/index.min.mjs": "sha384-7u1wA+HTsU4x9MUZHHHJ5ixSwhn2ZuigGKMhpNITH3jZYIumwDxfJtCduBj6wa2Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.503.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-caUG0wlqST00vfeHjd9vggyXqlAyaMUS1njbes5xmG6FaJuHNk0wgRAU/1Z4cb0G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.256.0/index.min.mjs": "sha384-caUG0wlqST00vfeHjd9vggyXqlAyaMUS1njbes5xmG6FaJuHNk0wgRAU/1Z4cb0G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.256.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.310.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.310.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l+teIiXmI2Kdt7ICHH4Od4EYQ8JPNqk6R3VhSmLvTvHqacfIrvniqzzBTZODJi3d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.310.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.310.0/index.min.mjs": "sha384-l+teIiXmI2Kdt7ICHH4Od4EYQ8JPNqk6R3VhSmLvTvHqacfIrvniqzzBTZODJi3d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.310.0/LICENSE
```

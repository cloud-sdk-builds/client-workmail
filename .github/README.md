...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qDgrEMiSCzspCLJw5AUaLkSdMcJ52BqvrNJQos92KR3/prIXeQSawjO7L3UUDYUh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.631.0/index.min.mjs": "sha384-qDgrEMiSCzspCLJw5AUaLkSdMcJ52BqvrNJQos92KR3/prIXeQSawjO7L3UUDYUh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.631.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5fsfqtfv1FTKp6UmLAP+5MRCAYeUZQfSNgTWEfUuALDbgdbIELgsxAm5ykdbNLNB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.891.0/index.min.mjs": "sha384-5fsfqtfv1FTKp6UmLAP+5MRCAYeUZQfSNgTWEfUuALDbgdbIELgsxAm5ykdbNLNB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.891.0/LICENSE
```

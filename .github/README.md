...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IbDPirwqxMCuwMPBhDBmbr493w3eS+OmH2kdkHNBgEZE/iS5/6KQaCnQgSpFY+6n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.229.0/index.min.mjs": "sha384-IbDPirwqxMCuwMPBhDBmbr493w3eS+OmH2kdkHNBgEZE/iS5/6KQaCnQgSpFY+6n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.229.0/LICENSE
```

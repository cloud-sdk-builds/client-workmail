...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7A8lzYi9MHwFrvucbF6J2BLq0f+PHdjAZ5GgtHWsrG+VSrIr5eum2ochg8jhaSUK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.928.0/index.min.mjs": "sha384-7A8lzYi9MHwFrvucbF6J2BLq0f+PHdjAZ5GgtHWsrG+VSrIr5eum2ochg8jhaSUK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.928.0/LICENSE
```

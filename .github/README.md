...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YRjG0JGbEg0dMo7CCJ9Lw2TQuTvcCicjjtDTD+cLXTd4hdL3diWshEdmCPJrQtUV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.922.0/index.min.mjs": "sha384-YRjG0JGbEg0dMo7CCJ9Lw2TQuTvcCicjjtDTD+cLXTd4hdL3diWshEdmCPJrQtUV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.922.0/LICENSE
```

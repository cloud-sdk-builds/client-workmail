...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rqmTeQtVhe4YhTfTzlAJgyipGy5vBVPJaMgxhcGVuxNZGu1Ryx6RaDE39nS5cZV3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.693.0/index.min.mjs": "sha384-rqmTeQtVhe4YhTfTzlAJgyipGy5vBVPJaMgxhcGVuxNZGu1Ryx6RaDE39nS5cZV3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.693.0/LICENSE
```

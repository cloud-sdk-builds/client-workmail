...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z+Zprpd+BApTgpM9Vbl9STHI0bITZBN8FQDaA9DMiDHclJGupopCAwf1WxlU90q6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.294.0/index.min.mjs": "sha384-Z+Zprpd+BApTgpM9Vbl9STHI0bITZBN8FQDaA9DMiDHclJGupopCAwf1WxlU90q6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.294.0/LICENSE
```

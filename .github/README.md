...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.415.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.415.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FmdO4b/IR36i9da2xjk9OYEefFZVj/VoYgaLvIPNfC9afNFk9cqhCOaH2exQJxuk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.415.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.415.0/index.min.mjs": "sha384-FmdO4b/IR36i9da2xjk9OYEefFZVj/VoYgaLvIPNfC9afNFk9cqhCOaH2exQJxuk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.415.0/LICENSE
```

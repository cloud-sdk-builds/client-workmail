...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z1qW8d0tsD/t8giOV4W1cfRu4qqJWVP3vo9OY1yc+L3eA5Bxy7egBZRkWe4YYLAe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.326.0/index.min.mjs": "sha384-z1qW8d0tsD/t8giOV4W1cfRu4qqJWVP3vo9OY1yc+L3eA5Bxy7egBZRkWe4YYLAe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.326.0/LICENSE
```

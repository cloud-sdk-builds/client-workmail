...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2lwFoXGGdV4WlJcHIwtfcPaU1fBQtZFkspyQc07WTtDVQDAHNVkWs1x1t4H5Pmiz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1.0/index.min.mjs": "sha384-2lwFoXGGdV4WlJcHIwtfcPaU1fBQtZFkspyQc07WTtDVQDAHNVkWs1x1t4H5Pmiz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1.0/LICENSE
```

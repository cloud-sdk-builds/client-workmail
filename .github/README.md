...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1009.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1009.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-237DkDJGuGb3rCjrizPBdGDP0CuzK7HqHT04xppy0MjcmO/SkNexGASjiFNVgVqk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1009.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1009.0/index.min.mjs": "sha384-237DkDJGuGb3rCjrizPBdGDP0CuzK7HqHT04xppy0MjcmO/SkNexGASjiFNVgVqk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1009.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SUHcOvuwslzvmozasoYcTqnEn2cxQo9mO1Ep1y4FRW6YiVTmcnDWKkKlkn5vas6b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.839.0/index.min.mjs": "sha384-SUHcOvuwslzvmozasoYcTqnEn2cxQo9mO1Ep1y4FRW6YiVTmcnDWKkKlkn5vas6b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.839.0/LICENSE
```

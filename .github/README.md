...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.75.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.75.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-54O1lb0WsAZZtNPPqkc2BK8A2VccFk9obQdsGM7BfvD+vGqjCSpJT84K7JMHugtp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.75.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.75.0/index.min.mjs": "sha384-54O1lb0WsAZZtNPPqkc2BK8A2VccFk9obQdsGM7BfvD+vGqjCSpJT84K7JMHugtp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.75.0/LICENSE
```

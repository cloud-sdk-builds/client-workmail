...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GPFAIxqj4vBJHUr1QGCjhhbLSF6myH0RYrouamVdfAI8ihSc8lV5sX/rtyLtph60
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.209.0/index.min.mjs": "sha384-GPFAIxqj4vBJHUr1QGCjhhbLSF6myH0RYrouamVdfAI8ihSc8lV5sX/rtyLtph60"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.209.0/LICENSE
```

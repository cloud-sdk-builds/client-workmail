...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/ZncLd6tCKeD+AdSA3Proq5H/YIlSorcuFDcMGHmLH85Whb0o50rjkPr8C6JIgts
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.161.0/index.min.mjs": "sha384-/ZncLd6tCKeD+AdSA3Proq5H/YIlSorcuFDcMGHmLH85Whb0o50rjkPr8C6JIgts"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.161.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hIBWA5/ckcGDyYcWZFgjQ3AhKJKDRAsREr1B0AQ2+jbC9MKuVPzLwRHTtfE5XxHA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.445.0/index.min.mjs": "sha384-hIBWA5/ckcGDyYcWZFgjQ3AhKJKDRAsREr1B0AQ2+jbC9MKuVPzLwRHTtfE5XxHA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.445.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.309.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.309.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IgiSJM2i3+dOIu3UntZOCnMF4hQGcTI0g4kxy0S0JSf9RV5smRif7F7x96ME8hcm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.309.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.309.0/index.min.mjs": "sha384-IgiSJM2i3+dOIu3UntZOCnMF4hQGcTI0g4kxy0S0JSf9RV5smRif7F7x96ME8hcm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.309.0/LICENSE
```

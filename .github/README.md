...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b7wdL9kSTyMe+h/bVfKcT4pnn9cV6CzFwhZ/A2gUjwLwEKqjMTeK5KMbsELiC+PS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.975.0/index.min.mjs": "sha384-b7wdL9kSTyMe+h/bVfKcT4pnn9cV6CzFwhZ/A2gUjwLwEKqjMTeK5KMbsELiC+PS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.975.0/LICENSE
```

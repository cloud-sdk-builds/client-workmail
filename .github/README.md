...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HzQ5RunQQa7Hi9TTwDCK3w8askY+I7q10T8NU+OjjOoObuUCdJmeIXl0fu5cqrN0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.588.0/index.min.mjs": "sha384-HzQ5RunQQa7Hi9TTwDCK3w8askY+I7q10T8NU+OjjOoObuUCdJmeIXl0fu5cqrN0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.588.0/LICENSE
```

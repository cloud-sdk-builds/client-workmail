...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.42.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.42.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PIdCcgjSySRdHJa33xpSi3vM+ua4RX2cuKiLvW9oT4EM5h/4cjFx/0b8vfR2q+dT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.42.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.42.0/index.min.mjs": "sha384-PIdCcgjSySRdHJa33xpSi3vM+ua4RX2cuKiLvW9oT4EM5h/4cjFx/0b8vfR2q+dT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.42.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xhio6Eyp+l1gzmXKIHGD6LEygCo384UWoSGhloJ34hhSseA45G8rYpG5XLeiFD0J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.337.0/index.min.mjs": "sha384-xhio6Eyp+l1gzmXKIHGD6LEygCo384UWoSGhloJ34hhSseA45G8rYpG5XLeiFD0J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.337.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UcUehx+izfOSq2Qom6UP/BfYH98r+Hwad3v91YyRWv5pe2KWTBI96sJRcuUFzqGk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.53.0/index.min.mjs": "sha384-UcUehx+izfOSq2Qom6UP/BfYH98r+Hwad3v91YyRWv5pe2KWTBI96sJRcuUFzqGk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.53.0/LICENSE
```

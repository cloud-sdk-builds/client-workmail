...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.80.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.80.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Lo7fGMsV9Hkt2N0x0DssrlenWSWWOhyP60/znVH7hRoZSz/dUEh8A1pkL3clOGyY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.80.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.80.0/index.min.mjs": "sha384-Lo7fGMsV9Hkt2N0x0DssrlenWSWWOhyP60/znVH7hRoZSz/dUEh8A1pkL3clOGyY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.80.0/LICENSE
```

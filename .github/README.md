...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.363.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.363.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+14AcNpMCpdEaKRAMrqTE4z8nJEaP0nrlHAW+Dw1UFeJnsJdcWKP7BziBrvbC/dY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.363.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.363.0/index.min.mjs": "sha384-+14AcNpMCpdEaKRAMrqTE4z8nJEaP0nrlHAW+Dw1UFeJnsJdcWKP7BziBrvbC/dY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.363.0/LICENSE
```

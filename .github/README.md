...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-03vt3GknRgab7qJ2K9giZ9dTEk1zGzPqJXfqNk0O+U6/J3Dp+bhV9bBXDfo0WifU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.931.0/index.min.mjs": "sha384-03vt3GknRgab7qJ2K9giZ9dTEk1zGzPqJXfqNk0O+U6/J3Dp+bhV9bBXDfo0WifU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.931.0/LICENSE
```

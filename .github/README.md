...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/V5foc1z3/ERufWNx8wkq7+v6PQMUkL+WOJQqvF+yS3vUSLpBAIKfcY2+27rchwh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.987.0/index.min.mjs": "sha384-/V5foc1z3/ERufWNx8wkq7+v6PQMUkL+WOJQqvF+yS3vUSLpBAIKfcY2+27rchwh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.987.0/LICENSE
```

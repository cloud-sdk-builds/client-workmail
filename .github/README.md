...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZTBTXGoD/1ELpDHLKcOh7yaZPqTx+edBe3dhK/qArVDYObbqQeqDcr05+Z5S128G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.354.0/index.min.mjs": "sha384-ZTBTXGoD/1ELpDHLKcOh7yaZPqTx+edBe3dhK/qArVDYObbqQeqDcr05+Z5S128G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.354.0/LICENSE
```

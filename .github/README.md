...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UsolFvUY9RLvVOqdX/wYf1QgwyghR+3gtVcVpQI6e3HQrGcIvqIEukAkPlKY51Vc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.504.0/index.min.mjs": "sha384-UsolFvUY9RLvVOqdX/wYf1QgwyghR+3gtVcVpQI6e3HQrGcIvqIEukAkPlKY51Vc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.504.0/LICENSE
```

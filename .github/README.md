...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Oq6m/2neTAtGXUq0fF6ja5mQUWu1ngoSmfNG30XZExPpUYqvRvly6snXf1yQpsVJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.549.0/index.min.mjs": "sha384-Oq6m/2neTAtGXUq0fF6ja5mQUWu1ngoSmfNG30XZExPpUYqvRvly6snXf1yQpsVJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.549.0/LICENSE
```

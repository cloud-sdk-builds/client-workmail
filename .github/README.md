...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-jLNCCWssPoUByCNeUawAPBE1NlBwvc0hkGezwNRvK09/Q/y+cMc0FyklfH2y05Ul
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.503.1/index.min.mjs": "sha384-jLNCCWssPoUByCNeUawAPBE1NlBwvc0hkGezwNRvK09/Q/y+cMc0FyklfH2y05Ul"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.503.1/LICENSE
```

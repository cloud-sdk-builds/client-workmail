...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P8plFPtTEJJzwM9VrIVhBfiS7Cx1C+B4tyV81p0vfRjDa2+Nnl9bPk0SVT5ttSos
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.476.0/index.min.mjs": "sha384-P8plFPtTEJJzwM9VrIVhBfiS7Cx1C+B4tyV81p0vfRjDa2+Nnl9bPk0SVT5ttSos"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.476.0/LICENSE
```

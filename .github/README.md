...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cz/n+rPC1mP6MASSSbfnMtwfNZLo583xI1txL/LKJu5eUcSs7OI0X/9Wj8IW1H3T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.258.0/index.min.mjs": "sha384-cz/n+rPC1mP6MASSSbfnMtwfNZLo583xI1txL/LKJu5eUcSs7OI0X/9Wj8IW1H3T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.258.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mMFOPXbQCtf/euxjAWhtRBYL8ekPYO+LIVle+QN4BYkpy4aYpGiVVr305F09kg5V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.405.0/index.min.mjs": "sha384-mMFOPXbQCtf/euxjAWhtRBYL8ekPYO+LIVle+QN4BYkpy4aYpGiVVr305F09kg5V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.405.0/LICENSE
```

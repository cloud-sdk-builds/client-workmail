...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tjfcp7LZ8MJ55jteS4owrhNHcRXGMqqI7qK5YvLgnwA2qdLMKbftWI8qS3bFaQx5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.282.0/index.min.mjs": "sha384-tjfcp7LZ8MJ55jteS4owrhNHcRXGMqqI7qK5YvLgnwA2qdLMKbftWI8qS3bFaQx5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.282.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nCQnyfHAW37nZdANghH6XerMoLVqKy0C6CmuYJIZD13/HwFloPVZ1Vt9vGgt7rQc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.936.0/index.min.mjs": "sha384-nCQnyfHAW37nZdANghH6XerMoLVqKy0C6CmuYJIZD13/HwFloPVZ1Vt9vGgt7rQc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.936.0/LICENSE
```

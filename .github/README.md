...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.211.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.211.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QRhYfyl8Teo7o2QYQys4a3E5fHPjD9FWdfZyyVF5fZmsR7ZeRAQCRMpcCqZP1OOQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.211.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.211.0/index.min.mjs": "sha384-QRhYfyl8Teo7o2QYQys4a3E5fHPjD9FWdfZyyVF5fZmsR7ZeRAQCRMpcCqZP1OOQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.211.0/LICENSE
```

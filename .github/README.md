...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZKmY8lXfEwQEEDp96Jhx0cXppiFJYfFFuu9Xplec2GNAzerFQTu2AWAmHSy9PEMJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.297.0/index.min.mjs": "sha384-ZKmY8lXfEwQEEDp96Jhx0cXppiFJYfFFuu9Xplec2GNAzerFQTu2AWAmHSy9PEMJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.297.0/LICENSE
```

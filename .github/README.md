...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wzLzwCYk2NAx6rogkt8qcT/TfinouT1SvEZLGEYmXlNEU0s2CPhs4QEyKFOKdY2R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.358.0/index.min.mjs": "sha384-wzLzwCYk2NAx6rogkt8qcT/TfinouT1SvEZLGEYmXlNEU0s2CPhs4QEyKFOKdY2R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.358.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ylTz+mrpvYA4DQrfVvIHBU2wH8d/7f1zvIhstnhX1N43yAKCWLzQLg255xVUtYP1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.369.0/index.min.mjs": "sha384-ylTz+mrpvYA4DQrfVvIHBU2wH8d/7f1zvIhstnhX1N43yAKCWLzQLg255xVUtYP1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.369.0/LICENSE
```

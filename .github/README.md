...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.953.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.953.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OIawd4nPs7AXabsc7wdd57wdQ8ZRcIa9UbQn/HXUdHnha0vKMJ1XpqYy26j/jHT4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.953.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.953.0/index.min.mjs": "sha384-OIawd4nPs7AXabsc7wdd57wdQ8ZRcIa9UbQn/HXUdHnha0vKMJ1XpqYy26j/jHT4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.953.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AYpJqV4H5UzIlmKPEgct5xSjelXkmhHBC5Rz6B3EB1wKTLvXHHsJlRJBNJzq7Bru
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.864.0/index.min.mjs": "sha384-AYpJqV4H5UzIlmKPEgct5xSjelXkmhHBC5Rz6B3EB1wKTLvXHHsJlRJBNJzq7Bru"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.864.0/LICENSE
```

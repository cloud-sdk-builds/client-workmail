...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PyVvvhBszPe1BUcSalXm22hfvpYCp8vOsO5egVgxOlCczzNGY5ZjQeiWwTfbpv+u
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.921.0/index.min.mjs": "sha384-PyVvvhBszPe1BUcSalXm22hfvpYCp8vOsO5egVgxOlCczzNGY5ZjQeiWwTfbpv+u"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.921.0/LICENSE
```

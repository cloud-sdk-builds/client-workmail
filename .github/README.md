...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iUuXwXSCv/XeZLXWl6MUcit/k9eqyVPEOO9xVfSHIlbPaSI8oA4vybVRKOah3TA7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.857.0/index.min.mjs": "sha384-iUuXwXSCv/XeZLXWl6MUcit/k9eqyVPEOO9xVfSHIlbPaSI8oA4vybVRKOah3TA7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.857.0/LICENSE
```

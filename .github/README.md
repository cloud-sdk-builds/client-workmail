...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1wwvo5fILVcJFN3ZX9TNndGghaR9tcisb1XdpFGFWQabRKIj96zNYGjX4hggmXPh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.523.0/index.min.mjs": "sha384-1wwvo5fILVcJFN3ZX9TNndGghaR9tcisb1XdpFGFWQabRKIj96zNYGjX4hggmXPh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.523.0/LICENSE
```

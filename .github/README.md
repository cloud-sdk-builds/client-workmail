...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m1RuM/ubVNkc+hdUZSZGs9cpf8Dcwqx/CBpC2JLvKDyI/ktRFCqrh9iNA4Sp9SZe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.887.0/index.min.mjs": "sha384-m1RuM/ubVNkc+hdUZSZGs9cpf8Dcwqx/CBpC2JLvKDyI/ktRFCqrh9iNA4Sp9SZe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.887.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.484.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.484.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9Ecbiz2+tkOJyjd/m80mA0DlqC5JFtofIBjD3CmJvs4C0xkTRA93BDR+Ys4UnJFS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.484.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.484.0/index.min.mjs": "sha384-9Ecbiz2+tkOJyjd/m80mA0DlqC5JFtofIBjD3CmJvs4C0xkTRA93BDR+Ys4UnJFS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.484.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x0AhgGJx5MPkpfnmN4awL76oYOC946u8YkaGiUl65qTVfvQ4RSFs0PleBuYJ5sra
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.25.0/index.min.mjs": "sha384-x0AhgGJx5MPkpfnmN4awL76oYOC946u8YkaGiUl65qTVfvQ4RSFs0PleBuYJ5sra"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.25.0/LICENSE
```

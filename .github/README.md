...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/IdxZirwMtFqv87yPT8ytZkXMUwZ2qM5/VX2VZgeIqPNgfHWUvd5hx7LZjna9dTT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.914.0/index.min.mjs": "sha384-/IdxZirwMtFqv87yPT8ytZkXMUwZ2qM5/VX2VZgeIqPNgfHWUvd5hx7LZjna9dTT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.914.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mb6TYLopwu0iS008+9HXs9NqhVh2xlE/2sIPuEf8evCOOWamUfuqPlSfCRnzZyMg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.907.0/index.min.mjs": "sha384-mb6TYLopwu0iS008+9HXs9NqhVh2xlE/2sIPuEf8evCOOWamUfuqPlSfCRnzZyMg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.907.0/LICENSE
```

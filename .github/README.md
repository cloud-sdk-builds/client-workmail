...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.449.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.449.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hWBXRS/vkhBQnYgAmnPry+ZgIaH/jxAREiSrfRSf2708osfl0JC+2zqW62QFCp0h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.449.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.449.0/index.min.mjs": "sha384-hWBXRS/vkhBQnYgAmnPry+ZgIaH/jxAREiSrfRSf2708osfl0JC+2zqW62QFCp0h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.449.0/LICENSE
```

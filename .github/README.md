...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QKfKwF86WF+hDwWS8NHI75G8k0UGCpwv2nXSklmMExmeg5A3RX50czpaALP72vCw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.799.0/index.min.mjs": "sha384-QKfKwF86WF+hDwWS8NHI75G8k0UGCpwv2nXSklmMExmeg5A3RX50czpaALP72vCw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.799.0/LICENSE
```

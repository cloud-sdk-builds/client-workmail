...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.198.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.198.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MCEwF8UfT1sqLsuiL8CCzjnxtLjC+rqQplkTq82UT4LMjHX1m75FGiJTVXjafP0b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.198.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.198.0/index.min.mjs": "sha384-MCEwF8UfT1sqLsuiL8CCzjnxtLjC+rqQplkTq82UT4LMjHX1m75FGiJTVXjafP0b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.198.0/LICENSE
```

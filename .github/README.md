...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.45.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.45.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pBPgzfn9ZY3kUpl04f4tnpS2l6GbiSO4wEa5EpaKQUuQ0+9+mJsMN3NzpevH+vad
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.45.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.45.0/index.min.mjs": "sha384-pBPgzfn9ZY3kUpl04f4tnpS2l6GbiSO4wEa5EpaKQUuQ0+9+mJsMN3NzpevH+vad"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.45.0/LICENSE
```

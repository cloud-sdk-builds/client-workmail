...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+8qwn7yjTaHUq85UkMzv3svrgsZmNXOivkkt9Lnfb755OcSmMeDWycVs7bP/qa1t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.796.0/index.min.mjs": "sha384-+8qwn7yjTaHUq85UkMzv3svrgsZmNXOivkkt9Lnfb755OcSmMeDWycVs7bP/qa1t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.796.0/LICENSE
```

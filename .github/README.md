...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1004.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1004.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l8EChRNwijrka54TOUjq5SGBdFC2MoCaBniigLG5qZ4t8Hnoya9A4SF/xrYryoMt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1004.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1004.0/index.min.mjs": "sha384-l8EChRNwijrka54TOUjq5SGBdFC2MoCaBniigLG5qZ4t8Hnoya9A4SF/xrYryoMt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1004.0/LICENSE
```

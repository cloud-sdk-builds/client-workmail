...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.245.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.245.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YJh5jK1VByYcd/yDPxi9Fi4zruRuCIAcVQJUZ3bWOOTrjQ/CDA+atFn5jkGKRLyE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.245.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.245.0/index.min.mjs": "sha384-YJh5jK1VByYcd/yDPxi9Fi4zruRuCIAcVQJUZ3bWOOTrjQ/CDA+atFn5jkGKRLyE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.245.0/LICENSE
```

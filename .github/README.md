...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h5B7qU6Fz8Ni3Qk0wiIHW4ZYBidrJ6XtWklP/2EeuzYW00fyt0AODsn0oHhWmnsQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.613.0/index.min.mjs": "sha384-h5B7qU6Fz8Ni3Qk0wiIHW4ZYBidrJ6XtWklP/2EeuzYW00fyt0AODsn0oHhWmnsQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.613.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/aakJTUEDWH6YGCAtInBAHC4lulCwM5KDy5/ccdV/Tuo1DGrsiZHo3PQN5W3juQu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.943.0/index.min.mjs": "sha384-/aakJTUEDWH6YGCAtInBAHC4lulCwM5KDy5/ccdV/Tuo1DGrsiZHo3PQN5W3juQu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.943.0/LICENSE
```

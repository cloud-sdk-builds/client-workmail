...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J4vGukVkmCnuqmBeAknHbk53RyUXwNUPEke25d5bowEmDWPlcP1akqm2jRywT5ql
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.994.0/index.min.mjs": "sha384-J4vGukVkmCnuqmBeAknHbk53RyUXwNUPEke25d5bowEmDWPlcP1akqm2jRywT5ql"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.994.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.485.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.485.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9kaGPrc41OTBNmThB+VQNM/+Ax+OaiQmeSWKIuhc0a1Llli1JqTNi1ZJ+Xu97q9v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.485.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.485.0/index.min.mjs": "sha384-9kaGPrc41OTBNmThB+VQNM/+Ax+OaiQmeSWKIuhc0a1Llli1JqTNi1ZJ+Xu97q9v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.485.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PSX7N5Nx4GTekOAmYDb/SWSexL6Hlq1hrhUx1JMZgiUFP8WCO5lliE7tneLz+5dU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.46.0/index.min.mjs": "sha384-PSX7N5Nx4GTekOAmYDb/SWSexL6Hlq1hrhUx1JMZgiUFP8WCO5lliE7tneLz+5dU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.46.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.110.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.110.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nflhNdYFX3Fgv7yGSvUI1J/G8dQ4IwtFHXYYZIx0X/YiQhPdt/4sEWwIlir09QUE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.110.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.110.0/index.min.mjs": "sha384-nflhNdYFX3Fgv7yGSvUI1J/G8dQ4IwtFHXYYZIx0X/YiQhPdt/4sEWwIlir09QUE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.110.0/LICENSE
```

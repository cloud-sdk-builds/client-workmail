...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.8.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.8.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-ONTpT7dHGWjEd4o29CVdYl970ArGBUICUIJRgERMazpPCJIvHB4L22ox/j5tl5XG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.8.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.8.1/index.min.mjs": "sha384-ONTpT7dHGWjEd4o29CVdYl970ArGBUICUIJRgERMazpPCJIvHB4L22ox/j5tl5XG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.8.1/LICENSE
```

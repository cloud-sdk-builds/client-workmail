...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZBwLvqng8YLuendfpGoyFBhx4dk/6DCc+UawueUXvO8Wn+70SpvE1Kx4CBOWZUC0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.658.1/index.min.mjs": "sha384-ZBwLvqng8YLuendfpGoyFBhx4dk/6DCc+UawueUXvO8Wn+70SpvE1Kx4CBOWZUC0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.658.1/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1023.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1023.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+kVr983YX+bhpj2iAsEHKA8YuXD6AXz/ZB2bEJQKPtwZ41PAwAllVb9VZWJAzPBB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1023.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1023.0/index.min.mjs": "sha384-+kVr983YX+bhpj2iAsEHKA8YuXD6AXz/ZB2bEJQKPtwZ41PAwAllVb9VZWJAzPBB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1023.0/LICENSE
```

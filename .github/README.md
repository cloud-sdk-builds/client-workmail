...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-89ZNZg/4KqmeG3QwKS6S6RildADm9l1+wgM36xwClnTSWAmBBGh3bOTNMWH15iMs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.127.0/index.min.mjs": "sha384-89ZNZg/4KqmeG3QwKS6S6RildADm9l1+wgM36xwClnTSWAmBBGh3bOTNMWH15iMs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.127.0/LICENSE
```

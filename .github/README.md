...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.915.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.915.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MhBmbJAxmkE46KNh+4LIVpmNjUyMJZLjmGbs2furDi4SdEpgH+bWgJu7rmqdgzc4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.915.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.915.0/index.min.mjs": "sha384-MhBmbJAxmkE46KNh+4LIVpmNjUyMJZLjmGbs2furDi4SdEpgH+bWgJu7rmqdgzc4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.915.0/LICENSE
```

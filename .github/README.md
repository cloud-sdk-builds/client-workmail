...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Vd1BRiBUUkiZS82NkqRiaPQruaELeDuq5gmCp4hUQHiKaqrB4I69ZZGh1zmzPQea
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.554.0/index.min.mjs": "sha384-Vd1BRiBUUkiZS82NkqRiaPQruaELeDuq5gmCp4hUQHiKaqrB4I69ZZGh1zmzPQea"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.554.0/LICENSE
```

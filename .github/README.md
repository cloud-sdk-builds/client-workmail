...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rhix42B3CrCOqiS7XMKmH0vgS4MOT6XJk9/Zx+D0jBdD00TeuYqHJLNrdh5Ti/zH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.738.0/index.min.mjs": "sha384-rhix42B3CrCOqiS7XMKmH0vgS4MOT6XJk9/Zx+D0jBdD00TeuYqHJLNrdh5Ti/zH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.738.0/LICENSE
```

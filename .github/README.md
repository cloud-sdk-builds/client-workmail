...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-38XeQyLxTlJlN1KQQ3SHSMQT7PSKW+Vq+YYyC4PUzcHu1/rOrpAV8fGCcIAtnmiY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.43.0/index.min.mjs": "sha384-38XeQyLxTlJlN1KQQ3SHSMQT7PSKW+Vq+YYyC4PUzcHu1/rOrpAV8fGCcIAtnmiY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.43.0/LICENSE
```

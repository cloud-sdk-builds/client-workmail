...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+nLmawefNGgm4uyRoOBIzdv/TBTIkQ1ot5ewlB0urs6JiL33dNKekIbWbB1myU0L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.859.0/index.min.mjs": "sha384-+nLmawefNGgm4uyRoOBIzdv/TBTIkQ1ot5ewlB0urs6JiL33dNKekIbWbB1myU0L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.859.0/LICENSE
```

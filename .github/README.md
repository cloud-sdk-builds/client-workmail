...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JazffVIKDYc8dH3GwLeiKX9tqS31sncZhHVBEr5lKwfzrHGF2lGT0ImebEYIPN73
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.168.0/index.min.mjs": "sha384-JazffVIKDYc8dH3GwLeiKX9tqS31sncZhHVBEr5lKwfzrHGF2lGT0ImebEYIPN73"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.168.0/LICENSE
```

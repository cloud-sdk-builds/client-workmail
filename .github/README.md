...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CH5A+DG//71SQKLaQH+BmmCWz7x7uM/w0sxFV9u1VCTVutEZ7ondT1b4ZuknXvhe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.408.0/index.min.mjs": "sha384-CH5A+DG//71SQKLaQH+BmmCWz7x7uM/w0sxFV9u1VCTVutEZ7ondT1b4ZuknXvhe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.408.0/LICENSE
```

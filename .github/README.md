...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.202.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.202.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eJAjnyY+yB08+XZNkFMdr/lnUIuhkfmSz11fH3PZcFXdy+PutFzUz0trbkGmJlfi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.202.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.202.0/index.min.mjs": "sha384-eJAjnyY+yB08+XZNkFMdr/lnUIuhkfmSz11fH3PZcFXdy+PutFzUz0trbkGmJlfi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.202.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L4ULI+V8yhKYVorzI5aZ3VVwCoWx703l2aXy0gZ9b9Ftzob5/fC0Olr3tQrFMzLY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.927.0/index.min.mjs": "sha384-L4ULI+V8yhKYVorzI5aZ3VVwCoWx703l2aXy0gZ9b9Ftzob5/fC0Olr3tQrFMzLY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.927.0/LICENSE
```

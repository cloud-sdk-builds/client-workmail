...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gm9HIWMqKeAkR/pip1zmnxVOov0s4Izd68o/dLcHJQJp2pQGUo1AQ24+SqnXLgoA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.24.0/index.min.mjs": "sha384-gm9HIWMqKeAkR/pip1zmnxVOov0s4Izd68o/dLcHJQJp2pQGUo1AQ24+SqnXLgoA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.24.0/LICENSE
```

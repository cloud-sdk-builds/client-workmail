...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rv4Cc5A3S9v7OyqgctQQ560aovK0aofcIkz+crQ3+rNKCMAd7o5Lh2Rkt3sDp531
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.92.0/index.min.mjs": "sha384-rv4Cc5A3S9v7OyqgctQQ560aovK0aofcIkz+crQ3+rNKCMAd7o5Lh2Rkt3sDp531"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.92.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.109.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MgdLGUgdqY1vU7ku9nDWZwSeY0jkMXcDhVVio3oGr6TxeHt0X3KxC4BYkOrJIgAB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.109.0/index.min.mjs": "sha384-MgdLGUgdqY1vU7ku9nDWZwSeY0jkMXcDhVVio3oGr6TxeHt0X3KxC4BYkOrJIgAB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.109.0/LICENSE
```

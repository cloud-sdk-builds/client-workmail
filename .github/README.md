...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-0gCnGviSGWi3CPzn7nEVeoZEoLjVGn01qiO/t3mqN9IeZDnVLsJckeA4NZLNO5CS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.620.1/index.min.mjs": "sha384-0gCnGviSGWi3CPzn7nEVeoZEoLjVGn01qiO/t3mqN9IeZDnVLsJckeA4NZLNO5CS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.620.1/LICENSE
```

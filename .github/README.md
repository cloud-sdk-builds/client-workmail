...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y2wwGEInYs0lRNzcWFnl9zNVFZPmrXGxJF81xibDrp8Qul6SWnCUKcXX00YMavoY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.454.0/index.min.mjs": "sha384-y2wwGEInYs0lRNzcWFnl9zNVFZPmrXGxJF81xibDrp8Qul6SWnCUKcXX00YMavoY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.454.0/LICENSE
```

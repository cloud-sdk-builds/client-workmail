...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SNtFQ8VjP2fi4vOwiDukL9EfCrpFkS9lC9bubYIlt/V9q9VAFeNGIGExh4wiW4sr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.804.0/index.min.mjs": "sha384-SNtFQ8VjP2fi4vOwiDukL9EfCrpFkS9lC9bubYIlt/V9q9VAFeNGIGExh4wiW4sr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.804.0/LICENSE
```

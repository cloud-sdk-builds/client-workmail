...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3C5++Dr6CN72eclDc0jSFqt0Nb9yglUj2SLtJZt91Bh5OfdKHRDDlTQQMNvW0y8/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.816.0/index.min.mjs": "sha384-3C5++Dr6CN72eclDc0jSFqt0Nb9yglUj2SLtJZt91Bh5OfdKHRDDlTQQMNvW0y8/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.816.0/LICENSE
```

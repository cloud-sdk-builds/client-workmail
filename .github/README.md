...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.12.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.12.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hFsGvK9ZNnM7/M/hNhxjh860SwuSbajH6xsx4mUUn7RzROMLm6GJYQFoqODjvKHB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.12.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.12.0/index.min.mjs": "sha384-hFsGvK9ZNnM7/M/hNhxjh860SwuSbajH6xsx4mUUn7RzROMLm6GJYQFoqODjvKHB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.12.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RcBrLg9cvlwuYAvQ90H+S3FtrCzlG78623l4nCXRV4hZPxJiSZWfqecu/zPphlg6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.441.0/index.min.mjs": "sha384-RcBrLg9cvlwuYAvQ90H+S3FtrCzlG78623l4nCXRV4hZPxJiSZWfqecu/zPphlg6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.441.0/LICENSE
```

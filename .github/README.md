...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J8SkjQSwdeMWuhrIWGuMy39Us/6eo29tWFCSKqpJby/AFJDFB+A+1aAT2s9uCa7Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.48.0/index.min.mjs": "sha384-J8SkjQSwdeMWuhrIWGuMy39Us/6eo29tWFCSKqpJby/AFJDFB+A+1aAT2s9uCa7Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.48.0/LICENSE
```

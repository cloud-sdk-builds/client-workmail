...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BK30O2kySOel+VAOkHqAu5mRxciEn7i2f3sZyyc2jBdSHYIMSWdJVG83k5DBRKPR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.499.0/index.min.mjs": "sha384-BK30O2kySOel+VAOkHqAu5mRxciEn7i2f3sZyyc2jBdSHYIMSWdJVG83k5DBRKPR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.499.0/LICENSE
```

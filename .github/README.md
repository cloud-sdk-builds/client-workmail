...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fuQK9mQSEF7Xw3770WnmU832RwCwSzfsBlERcMOaRpLGSNwnQLFGQpmIL6JOjyF+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.85.0/index.min.mjs": "sha384-fuQK9mQSEF7Xw3770WnmU832RwCwSzfsBlERcMOaRpLGSNwnQLFGQpmIL6JOjyF+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.85.0/LICENSE
```

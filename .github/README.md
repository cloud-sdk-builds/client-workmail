...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zeksy/dv1joA3JhR/RAssHTNUsNDh5jz1K8aLe3bOeU3r+zBKwGycCzNzEUcJNo4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.218.0/index.min.mjs": "sha384-zeksy/dv1joA3JhR/RAssHTNUsNDh5jz1K8aLe3bOeU3r+zBKwGycCzNzEUcJNo4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.218.0/LICENSE
```

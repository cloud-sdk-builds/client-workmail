...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aWduahIEqQMB/oTF1/9a/mssKPHLZRfe0pP9ipOpy4xkJyxzog5FA3qKNFR+Ht/Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.540.0/index.min.mjs": "sha384-aWduahIEqQMB/oTF1/9a/mssKPHLZRfe0pP9ipOpy4xkJyxzog5FA3qKNFR+Ht/Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.540.0/LICENSE
```

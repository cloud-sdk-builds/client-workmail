...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zjOc8dDBRBrQd/jdx5c3YJQHUowc01tgNNq9YSAwg7ePglvVF/dTtEMFdfOv8OOG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.288.0/index.min.mjs": "sha384-zjOc8dDBRBrQd/jdx5c3YJQHUowc01tgNNq9YSAwg7ePglvVF/dTtEMFdfOv8OOG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.288.0/LICENSE
```

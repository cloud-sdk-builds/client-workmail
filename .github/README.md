...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hM8xNkP9y88xF4zgE/XN5LTCqwZaZSkLu5q+Dy8SA6dzc+DJ+sf2uROp22voxkHW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.668.0/index.min.mjs": "sha384-hM8xNkP9y88xF4zgE/XN5LTCqwZaZSkLu5q+Dy8SA6dzc+DJ+sf2uROp22voxkHW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.668.0/LICENSE
```

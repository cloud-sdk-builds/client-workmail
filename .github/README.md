...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1026.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1026.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nAcMMT+6WSdr1VmGMyMo8D5GFxelBSCQy/i30CgTfyT94C1OGuf+d9HGhyzREulL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1026.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1026.0/index.min.mjs": "sha384-nAcMMT+6WSdr1VmGMyMo8D5GFxelBSCQy/i30CgTfyT94C1OGuf+d9HGhyzREulL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1026.0/LICENSE
```

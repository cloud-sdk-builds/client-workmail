...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.95.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.95.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PoH4y4alRXhhvh+0JvppCdpGGBBb4Ci/wWqk030dpnH8SOxVGNrA6T32QiQmTneM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.95.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.95.0/index.min.mjs": "sha384-PoH4y4alRXhhvh+0JvppCdpGGBBb4Ci/wWqk030dpnH8SOxVGNrA6T32QiQmTneM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.95.0/LICENSE
```

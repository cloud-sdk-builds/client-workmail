...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mAaCO/EX5aG2xBH8oPG5f+XDoA3JndXlP/2uW7strJLP2GF+1SIoypdcFYKYjQqg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.971.0/index.min.mjs": "sha384-mAaCO/EX5aG2xBH8oPG5f+XDoA3JndXlP/2uW7strJLP2GF+1SIoypdcFYKYjQqg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.971.0/LICENSE
```

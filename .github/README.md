...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r9OlOWBSkJ/82hKdt68kESpsGmR7JK8Abxx7TabFm69Ojv7DflTFUJE9hJpWTNLd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.20.0/index.min.mjs": "sha384-r9OlOWBSkJ/82hKdt68kESpsGmR7JK8Abxx7TabFm69Ojv7DflTFUJE9hJpWTNLd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.20.0/LICENSE
```

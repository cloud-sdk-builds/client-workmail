...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-abHdiFvoSSaN7H9U8tKDdqDCS17XVI1iFbSTsaqBVtdlJ7ddO5ktHisLQELP2YKQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.828.0/index.min.mjs": "sha384-abHdiFvoSSaN7H9U8tKDdqDCS17XVI1iFbSTsaqBVtdlJ7ddO5ktHisLQELP2YKQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.828.0/LICENSE
```

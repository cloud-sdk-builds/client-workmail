...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i2tGvuB0zDRqDhWegK5yRuLSTzEskIcpK+t1srl0kKt5HAbIomHIBbFSz8b7dSgT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.587.0/index.min.mjs": "sha384-i2tGvuB0zDRqDhWegK5yRuLSTzEskIcpK+t1srl0kKt5HAbIomHIBbFSz8b7dSgT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.587.0/LICENSE
```

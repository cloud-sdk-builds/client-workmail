...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8IlZCZTQkO0CIpJZi9Zh/0bSRpXrk8r+kiibLNQaCj0vceXK9+MM+OWG9wRG7Hod
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.906.0/index.min.mjs": "sha384-8IlZCZTQkO0CIpJZi9Zh/0bSRpXrk8r+kiibLNQaCj0vceXK9+MM+OWG9wRG7Hod"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.906.0/LICENSE
```

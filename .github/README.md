...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A+Ga3OBCjzEZRYiH4DICUay1mA2eUXizK8nkCLK7dEfnJoHW/trqVFm7W+Um1tVQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.709.0/index.min.mjs": "sha384-A+Ga3OBCjzEZRYiH4DICUay1mA2eUXizK8nkCLK7dEfnJoHW/trqVFm7W+Um1tVQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.709.0/LICENSE
```

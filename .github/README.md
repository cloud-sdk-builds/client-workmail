...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BEQr80oBqINSBBfW7HWm8MmA+V59GMmLXBHTA/Qinro7X2nk/YPnGMuAeV2Fq9xE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.327.0/index.min.mjs": "sha384-BEQr80oBqINSBBfW7HWm8MmA+V59GMmLXBHTA/Qinro7X2nk/YPnGMuAeV2Fq9xE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.327.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xpMu2Ngkepq/C7FD8eEj2VwbZnbwDQ628pzEO5YTyS2UK+QSJwocCWcTQqjAHso9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.989.0/index.min.mjs": "sha384-xpMu2Ngkepq/C7FD8eEj2VwbZnbwDQ628pzEO5YTyS2UK+QSJwocCWcTQqjAHso9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.989.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l21ZF27AhVqGDyf3jKeP58Cv5hLEiFr8WpUMO4cEOIGLMxoM+vYMGavieTgW9LkD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.150.0/index.min.mjs": "sha384-l21ZF27AhVqGDyf3jKeP58Cv5hLEiFr8WpUMO4cEOIGLMxoM+vYMGavieTgW9LkD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.150.0/LICENSE
```

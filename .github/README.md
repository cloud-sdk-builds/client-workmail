...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-fiHWG5dn9R5QpVv0u7PGswqz1qbfpVwz5iMPHQAMib7I7UwZJcFDa6MGgdnQ5ZYV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.379.1/index.min.mjs": "sha384-fiHWG5dn9R5QpVv0u7PGswqz1qbfpVwz5iMPHQAMib7I7UwZJcFDa6MGgdnQ5ZYV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.379.1/LICENSE
```

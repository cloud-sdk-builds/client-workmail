...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+7lCeR/gCqon6elP1sqb6rcnwEXdheRP1DGUNtJO9r2X6/9EdwQCaOSMzKYhcG/x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.29.0/index.min.mjs": "sha384-+7lCeR/gCqon6elP1sqb6rcnwEXdheRP1DGUNtJO9r2X6/9EdwQCaOSMzKYhcG/x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.29.0/LICENSE
```

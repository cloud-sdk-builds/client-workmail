...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CWo4ErAq82OkTYD2kvwrWCo4bVxRggkQBjwXCJdCTZtm1ULeGwyyUFP2YVJ/5bFz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.743.0/index.min.mjs": "sha384-CWo4ErAq82OkTYD2kvwrWCo4bVxRggkQBjwXCJdCTZtm1ULeGwyyUFP2YVJ/5bFz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.743.0/LICENSE
```

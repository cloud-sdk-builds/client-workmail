...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.637.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.637.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t8NFeZlM95LZzFXGCA/ppY1HSTpey77fkWUhiRCRTO+q+q5ixVUCZdNyBuoxO4FR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.637.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.637.0/index.min.mjs": "sha384-t8NFeZlM95LZzFXGCA/ppY1HSTpey77fkWUhiRCRTO+q+q5ixVUCZdNyBuoxO4FR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.637.0/LICENSE
```

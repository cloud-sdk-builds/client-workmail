...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7H6h5y/VlpcVqlUAZpieHX7vIuqZ+Pg2N2KzDtWE4OIzvwBbh0DGyv+IxbKW+ygJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.350.0/index.min.mjs": "sha384-7H6h5y/VlpcVqlUAZpieHX7vIuqZ+Pg2N2KzDtWE4OIzvwBbh0DGyv+IxbKW+ygJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.350.0/LICENSE
```

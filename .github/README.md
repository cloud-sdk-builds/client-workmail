...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-innZgM/tDlQjHm9u3OICYlCnIc3D55+vJHPoc75g5zWNu5WsLndeku6SWAIGVgJ2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.899.0/index.min.mjs": "sha384-innZgM/tDlQjHm9u3OICYlCnIc3D55+vJHPoc75g5zWNu5WsLndeku6SWAIGVgJ2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.899.0/LICENSE
```

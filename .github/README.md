...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-UCAeswMDa9dMmShX/vPC24u5tz6aug3tDI8nhatUS2l/TvIwG1cum+nzlIEYAWny
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.651.1/index.min.mjs": "sha384-UCAeswMDa9dMmShX/vPC24u5tz6aug3tDI8nhatUS2l/TvIwG1cum+nzlIEYAWny"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.651.1/LICENSE
```

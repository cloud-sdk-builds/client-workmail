...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xbjZb8SCFUWWRgmhGtlHPZsCzyXzOwWo4HA2OXDY6MZUjbcoz+f5l1/y7e/u6g9Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.749.0/index.min.mjs": "sha384-xbjZb8SCFUWWRgmhGtlHPZsCzyXzOwWo4HA2OXDY6MZUjbcoz+f5l1/y7e/u6g9Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.749.0/LICENSE
```

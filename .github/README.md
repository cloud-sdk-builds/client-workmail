...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.450.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.450.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lq7oznR0zmUb5IUiYPmZp5sGTxNkLoljFhs3xWh5B/9WqLXzKKCjdGtQ3UhpSUvG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.450.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.450.0/index.min.mjs": "sha384-lq7oznR0zmUb5IUiYPmZp5sGTxNkLoljFhs3xWh5B/9WqLXzKKCjdGtQ3UhpSUvG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.450.0/LICENSE
```

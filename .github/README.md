...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-y+UGhp6WA3M63rMPp/iwtbs9Sa0ptrVyQ3GekYs7G80qpgSQErNR4VFKUwzdaHKU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.74.0/index.min.mjs": "sha384-y+UGhp6WA3M63rMPp/iwtbs9Sa0ptrVyQ3GekYs7G80qpgSQErNR4VFKUwzdaHKU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.74.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-54GxrqbGVSDl24VNQZAYNRtsff3Igjpt5bt3B+8PlXP7ovhKmeVqboKKKjW5Vdkc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.845.0/index.min.mjs": "sha384-54GxrqbGVSDl24VNQZAYNRtsff3Igjpt5bt3B+8PlXP7ovhKmeVqboKKKjW5Vdkc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.845.0/LICENSE
```

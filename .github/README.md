...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZDFDYhmOJMGaNcNZaPaiMo2m0ZqbnFW2VNtrPM2GKJhCQ6UEjB/EFz5Ug6h4H0Ou
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.338.0/index.min.mjs": "sha384-ZDFDYhmOJMGaNcNZaPaiMo2m0ZqbnFW2VNtrPM2GKJhCQ6UEjB/EFz5Ug6h4H0Ou"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.338.0/LICENSE
```

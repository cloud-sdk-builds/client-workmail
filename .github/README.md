...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.431.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.431.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zPGvLJtaKHc7gk9r5lZxaf1L7MyEmIMqHYpKIv2qOIRX46e4kIuUGJUp6DlONYUW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.431.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.431.0/index.min.mjs": "sha384-zPGvLJtaKHc7gk9r5lZxaf1L7MyEmIMqHYpKIv2qOIRX46e4kIuUGJUp6DlONYUW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.431.0/LICENSE
```

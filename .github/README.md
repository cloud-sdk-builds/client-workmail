...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NRDvn8Ko8K+NWu6Ftwo5pr9JAcw22uQsbg9Pgkyi+SD5v1+iwgmBgeLQjyngTWsa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.812.0/index.min.mjs": "sha384-NRDvn8Ko8K+NWu6Ftwo5pr9JAcw22uQsbg9Pgkyi+SD5v1+iwgmBgeLQjyngTWsa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.812.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.347.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.347.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W2aCSi14jsqij35j2V4JOsaqHhBhXgzK2uBi1VpH+V/Bc12T8SgvUUiUIKVJ5OYV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.347.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.347.0/index.min.mjs": "sha384-W2aCSi14jsqij35j2V4JOsaqHhBhXgzK2uBi1VpH+V/Bc12T8SgvUUiUIKVJ5OYV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.347.0/LICENSE
```

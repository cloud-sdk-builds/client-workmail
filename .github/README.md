...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+N5qcSA/JmG5dnt1AB9JzJK3qu5JSUCr2NN4Tjb0WekzkDfIbBT97VIZAumKj4jw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.873.0/index.min.mjs": "sha384-+N5qcSA/JmG5dnt1AB9JzJK3qu5JSUCr2NN4Tjb0WekzkDfIbBT97VIZAumKj4jw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.873.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K4v5YJ6CIMPUojk8kkby57q7byAvqZCIDyFr4M6uek+pntsR9l/Kru0QuuqqONRm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.933.0/index.min.mjs": "sha384-K4v5YJ6CIMPUojk8kkby57q7byAvqZCIDyFr4M6uek+pntsR9l/Kru0QuuqqONRm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.933.0/LICENSE
```

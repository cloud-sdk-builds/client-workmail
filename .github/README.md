...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cyl4fF+mTU1ndRjZsCTAmNzdZag4WiR0NpJ+K9M/ZTExCoZ3pdV84nlu2ZT/A6ym
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.257.0/index.min.mjs": "sha384-Cyl4fF+mTU1ndRjZsCTAmNzdZag4WiR0NpJ+K9M/ZTExCoZ3pdV84nlu2ZT/A6ym"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.257.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SajGVk2t+qZEcgKojuNpfVXgPdmyf5rUF02rRMONBvs1wjnEURAqAjnE5IY4l+7j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.782.0/index.min.mjs": "sha384-SajGVk2t+qZEcgKojuNpfVXgPdmyf5rUF02rRMONBvs1wjnEURAqAjnE5IY4l+7j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.782.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qYeS8gZxW7rgDcf9OkzPMeqUFY+0/elUw+fWJz6Kp33FSI+OXSnCD5/bI39KmMFi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.965.0/index.min.mjs": "sha384-qYeS8gZxW7rgDcf9OkzPMeqUFY+0/elUw+fWJz6Kp33FSI+OXSnCD5/bI39KmMFi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.965.0/LICENSE
```

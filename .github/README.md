...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8UVJoGOnD8L050t0Fi/yr6yZFcTucpR35vj6iKRvEG1TZS6Kq6gnJZk2DleLI+aR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.295.0/index.min.mjs": "sha384-8UVJoGOnD8L050t0Fi/yr6yZFcTucpR35vj6iKRvEG1TZS6Kq6gnJZk2DleLI+aR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.295.0/LICENSE
```

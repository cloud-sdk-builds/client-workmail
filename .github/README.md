...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mlhVdDDSMfj3ZJxeiceTIPhEO3p8ycdoO16xlhLb2lRmnZzVCancMzFmpm6sq5Tx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.289.0/index.min.mjs": "sha384-mlhVdDDSMfj3ZJxeiceTIPhEO3p8ycdoO16xlhLb2lRmnZzVCancMzFmpm6sq5Tx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.289.0/LICENSE
```

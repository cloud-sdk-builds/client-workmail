...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YJjx1C4KJpeO/moM5zLaq0qhB7fRs8fo1wB2EEfNTisPmyGvvF3eOAClk4VSAfsJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.421.0/index.min.mjs": "sha384-YJjx1C4KJpeO/moM5zLaq0qhB7fRs8fo1wB2EEfNTisPmyGvvF3eOAClk4VSAfsJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.421.0/LICENSE
```

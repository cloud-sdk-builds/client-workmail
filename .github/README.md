...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MA2mm6psxlsbQMqgIx3UdDSJYb8oiTlkl44sV/otYBPsP/Ly7Cy8VbT7Y3Fj64po
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.629.0/index.min.mjs": "sha384-MA2mm6psxlsbQMqgIx3UdDSJYb8oiTlkl44sV/otYBPsP/Ly7Cy8VbT7Y3Fj64po"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.629.0/LICENSE
```

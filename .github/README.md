...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-5UM0B04B9bJoG8IVPwxsDJUTFrrpjktjZSWrZB+Kgj9xyUcOH6LLv8Uf+sJ7OgfD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.731.1/index.min.mjs": "sha384-5UM0B04B9bJoG8IVPwxsDJUTFrrpjktjZSWrZB+Kgj9xyUcOH6LLv8Uf+sJ7OgfD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.731.1/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GUHA319scNYDhnAImto++QxdjGQ5HnYeuEo+jxofF9XoKWWbt/ysie4dbpZpYJ5Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.572.0/index.min.mjs": "sha384-GUHA319scNYDhnAImto++QxdjGQ5HnYeuEo+jxofF9XoKWWbt/ysie4dbpZpYJ5Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.572.0/LICENSE
```

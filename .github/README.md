...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Vbxr14WeiHeCkRsZ7AxuWVqVqe0Vxh0AXR3q7VBxyrgNKbYzgRqnQLpKRIEEeTeU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.391.0/index.min.mjs": "sha384-Vbxr14WeiHeCkRsZ7AxuWVqVqe0Vxh0AXR3q7VBxyrgNKbYzgRqnQLpKRIEEeTeU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.391.0/LICENSE
```

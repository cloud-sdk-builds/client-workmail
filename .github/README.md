...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.137.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.137.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gW+1gtQxjAw/Pjzfybs6rAnRsQS7j2QHGx16xW2wmSIF/r5L3XR7vrHUtK72GNAk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.137.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.137.0/index.min.mjs": "sha384-gW+1gtQxjAw/Pjzfybs6rAnRsQS7j2QHGx16xW2wmSIF/r5L3XR7vrHUtK72GNAk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.137.0/LICENSE
```

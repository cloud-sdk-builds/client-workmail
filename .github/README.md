...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+0k8ZQ6KdtW1C25LIvkWbRCFeIGm69+uSrBmFEg9jhPObzsqlx77vboi2l1al3kp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.212.0/index.min.mjs": "sha384-+0k8ZQ6KdtW1C25LIvkWbRCFeIGm69+uSrBmFEg9jhPObzsqlx77vboi2l1al3kp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.212.0/LICENSE
```

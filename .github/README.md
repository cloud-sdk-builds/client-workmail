...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xw6VnIdaH+llg9U45+duJI1Frfnkk6CkOE0XUul2eYLl4MqL+WzYR1Uulpc1dlWJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.51.0/index.min.mjs": "sha384-xw6VnIdaH+llg9U45+duJI1Frfnkk6CkOE0XUul2eYLl4MqL+WzYR1Uulpc1dlWJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.51.0/LICENSE
```

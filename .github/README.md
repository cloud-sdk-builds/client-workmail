...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-In86i4wxDslcPFMl+od13elX43HKrGCrWQxOEYxvawyWF5CQrWUqMPYKboAY2jPa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.81.0/index.min.mjs": "sha384-In86i4wxDslcPFMl+od13elX43HKrGCrWQxOEYxvawyWF5CQrWUqMPYKboAY2jPa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.81.0/LICENSE
```

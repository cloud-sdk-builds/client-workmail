...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4nfDR/OGJQYN5vhpFR7MzgdBxf3SN0elPc0GnJZSPOOWx+olAZjTQcmz3M1aEwbe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.699.0/index.min.mjs": "sha384-4nfDR/OGJQYN5vhpFR7MzgdBxf3SN0elPc0GnJZSPOOWx+olAZjTQcmz3M1aEwbe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.699.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TeHIzsthP3svZ9Npgn8dkWUlc98b5HgztSbglCQEr6lXirhcwbD/Ggnrjd1mWv1y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.797.0/index.min.mjs": "sha384-TeHIzsthP3svZ9Npgn8dkWUlc98b5HgztSbglCQEr6lXirhcwbD/Ggnrjd1mWv1y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.797.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ul48MRN13wXGHd5IPq8jcfIhnRK/Yu7rKH1UdL0Rq67rz8sF9Xxykjfgj/7vHQEh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.100.0/index.min.mjs": "sha384-ul48MRN13wXGHd5IPq8jcfIhnRK/Yu7rKH1UdL0Rq67rz8sF9Xxykjfgj/7vHQEh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.100.0/LICENSE
```

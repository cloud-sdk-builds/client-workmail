...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3XEgEeUUHuVsP8MRSZQjdJdPPj/sxH+qRVI/k5J7FaKczA4y2Am+DcPJg4T3/tkI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.370.0/index.min.mjs": "sha384-3XEgEeUUHuVsP8MRSZQjdJdPPj/sxH+qRVI/k5J7FaKczA4y2Am+DcPJg4T3/tkI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.370.0/LICENSE
```

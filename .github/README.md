...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.162.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.162.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IvGISE9NmIqlMgMIQGsvo+YBfziINber5xJD2MWD6P71/oUpVYMPMtQS6Baz2Vcg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.162.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.162.0/index.min.mjs": "sha384-IvGISE9NmIqlMgMIQGsvo+YBfziINber5xJD2MWD6P71/oUpVYMPMtQS6Baz2Vcg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.162.0/LICENSE
```

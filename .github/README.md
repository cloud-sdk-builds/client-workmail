...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K3kIXmg1uhyfXwHA+VwLCmXqvChFkwhVR3xVHwD/7d4W5f3Mzp+tH6D2ljWkyZkz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.623.0/index.min.mjs": "sha384-K3kIXmg1uhyfXwHA+VwLCmXqvChFkwhVR3xVHwD/7d4W5f3Mzp+tH6D2ljWkyZkz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.623.0/LICENSE
```

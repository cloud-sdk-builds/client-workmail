...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/8iBxRhAyuCSoBi1DCw9wi676KX2dsQ6l8Ayhk/SiaezmnAb0MXHOEmPB0GtzJgJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.335.0/index.min.mjs": "sha384-/8iBxRhAyuCSoBi1DCw9wi676KX2dsQ6l8Ayhk/SiaezmnAb0MXHOEmPB0GtzJgJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.335.0/LICENSE
```

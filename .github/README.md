...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RCNMlVYtE55JnK3vlH7HWD/0mJwGYpXB4niNtW1IZfdnmX8qW7lRkRNdJ2FnLmB4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.19.0/index.min.mjs": "sha384-RCNMlVYtE55JnK3vlH7HWD/0mJwGYpXB4niNtW1IZfdnmX8qW7lRkRNdJ2FnLmB4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.19.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.880.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.880.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p0Q9LIx58yfslGi7ambTX+xsLgpOKFw7lkT6vARCnWTj2c0IIKuT66T2IUhhuHtC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.880.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.880.0/index.min.mjs": "sha384-p0Q9LIx58yfslGi7ambTX+xsLgpOKFw7lkT6vARCnWTj2c0IIKuT66T2IUhhuHtC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.880.0/LICENSE
```

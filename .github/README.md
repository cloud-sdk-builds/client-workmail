...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZMOOr6B9x+tqAp5AZkCDMW7yoDn5Z+btRCxPEUe8pSz+Gbz5F81wfv0m+nNJU4Lz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.18.0/index.min.mjs": "sha384-ZMOOr6B9x+tqAp5AZkCDMW7yoDn5Z+btRCxPEUe8pSz+Gbz5F81wfv0m+nNJU4Lz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.18.0/LICENSE
```

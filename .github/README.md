...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.13.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.13.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8G8g+S61p51dF5UioXsaHtl/ULT60t4HASJQBYEyxufCZVYDLUdUGxbFCQR8S8/N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.13.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.13.0/index.min.mjs": "sha384-8G8g+S61p51dF5UioXsaHtl/ULT60t4HASJQBYEyxufCZVYDLUdUGxbFCQR8S8/N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.13.0/LICENSE
```

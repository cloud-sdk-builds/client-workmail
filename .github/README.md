...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Sv1tkOCKsttEFwtbUbTFi8Uq6RTBgr0VrqQBRpt4uvTEeZMpoIKHnPTRIGcKPDbC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.650.0/index.min.mjs": "sha384-Sv1tkOCKsttEFwtbUbTFi8Uq6RTBgr0VrqQBRpt4uvTEeZMpoIKHnPTRIGcKPDbC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.650.0/LICENSE
```

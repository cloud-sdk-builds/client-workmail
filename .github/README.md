...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-a0ENoArnmoZzNr2HACTNMskFmEXCBhmsYV2sGXt456cQo4dAuqfHEhWCA75HvjN7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.477.0/index.min.mjs": "sha384-a0ENoArnmoZzNr2HACTNMskFmEXCBhmsYV2sGXt456cQo4dAuqfHEhWCA75HvjN7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.477.0/LICENSE
```

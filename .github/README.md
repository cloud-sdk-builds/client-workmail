...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JtSm1V0OGfgVZkLDMYSr+8fn8j7YjzerdbGAkIHN85mJ61L2myaj0P/WH6pJJAOS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.968.0/index.min.mjs": "sha384-JtSm1V0OGfgVZkLDMYSr+8fn8j7YjzerdbGAkIHN85mJ61L2myaj0P/WH6pJJAOS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.968.0/LICENSE
```

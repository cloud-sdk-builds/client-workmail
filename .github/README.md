...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1016.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1016.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F/IQx4QgeSXI3BWAb+pzy5BeP8xrNeISYAxcZS4IcKpIiju2WuLbOsNAuy96Mhof
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1016.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1016.0/index.min.mjs": "sha384-F/IQx4QgeSXI3BWAb+pzy5BeP8xrNeISYAxcZS4IcKpIiju2WuLbOsNAuy96Mhof"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1016.0/LICENSE
```

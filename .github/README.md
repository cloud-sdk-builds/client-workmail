...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AXU4RL1guSswsKH32JMQuAi1gaRGG3V5ndJjRVJlRfp/LHTGmGwPitvXlUjjICFs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.775.0/index.min.mjs": "sha384-AXU4RL1guSswsKH32JMQuAi1gaRGG3V5ndJjRVJlRfp/LHTGmGwPitvXlUjjICFs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.775.0/LICENSE
```

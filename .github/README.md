...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2637DVf84TWB52Zlqi695bEwhlaECaxQmleeZoKWe6yMFZaGMcpH+pktBNphKzlH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.348.0/index.min.mjs": "sha384-2637DVf84TWB52Zlqi695bEwhlaECaxQmleeZoKWe6yMFZaGMcpH+pktBNphKzlH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.348.0/LICENSE
```

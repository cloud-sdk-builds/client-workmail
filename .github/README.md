...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.614.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.614.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JJakmW6QpGnVCGvBUx9lXAHkdDSeZHy4UOJ8c3RC67aHHQTVg81KSCSHboUdvZxT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.614.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.614.0/index.min.mjs": "sha384-JJakmW6QpGnVCGvBUx9lXAHkdDSeZHy4UOJ8c3RC67aHHQTVg81KSCSHboUdvZxT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.614.0/LICENSE
```

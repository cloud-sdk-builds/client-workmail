...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.674.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.674.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hOQtHyFY7JPswAPv3sRIxa6NM64s7fRm5tZ1NwoRJNM9+Aiq2wa91ZQaJr5nZOFr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.674.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.674.0/index.min.mjs": "sha384-hOQtHyFY7JPswAPv3sRIxa6NM64s7fRm5tZ1NwoRJNM9+Aiq2wa91ZQaJr5nZOFr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.674.0/LICENSE
```

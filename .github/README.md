...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SzWMeO++o3kGAvQy10EP0pS+NLk0MGRLbuEnlsjmW+Q6p5IaWgsFbyH3jboyFUrg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.691.0/index.min.mjs": "sha384-SzWMeO++o3kGAvQy10EP0pS+NLk0MGRLbuEnlsjmW+Q6p5IaWgsFbyH3jboyFUrg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.691.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3wF6h8uWJ6tn4cfjGhfAKqiNBUavzN4ychkdKX2bOTcuPwp+T/l3jH9ZF12YUJOo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.213.0/index.min.mjs": "sha384-3wF6h8uWJ6tn4cfjGhfAKqiNBUavzN4ychkdKX2bOTcuPwp+T/l3jH9ZF12YUJOo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.213.0/LICENSE
```

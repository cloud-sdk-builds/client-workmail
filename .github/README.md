...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8MEIcivgIT07eWbPJOBwpqJ3Ji7tCWC04dZVWpZQXT844A7m2XzpNPSteCLZoUlR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.513.0/index.min.mjs": "sha384-8MEIcivgIT07eWbPJOBwpqJ3Ji7tCWC04dZVWpZQXT844A7m2XzpNPSteCLZoUlR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.513.0/LICENSE
```

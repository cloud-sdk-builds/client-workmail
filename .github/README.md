...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-anS8OlArOm5RO/3FSt2W9wubEUKg45YkiBam7T9NnsYnKGK5ALQWlkeDEFYEqFI4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.58.0/index.min.mjs": "sha384-anS8OlArOm5RO/3FSt2W9wubEUKg45YkiBam7T9NnsYnKGK5ALQWlkeDEFYEqFI4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.58.0/LICENSE
```

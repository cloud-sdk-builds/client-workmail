...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eyMO7QvgbBO/wEXz/VHNCTtNMOsIong0KysWXQnxWdrkMxVwHnwy1SAx89EzR/6C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.27.0/index.min.mjs": "sha384-eyMO7QvgbBO/wEXz/VHNCTtNMOsIong0KysWXQnxWdrkMxVwHnwy1SAx89EzR/6C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.27.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s/OXGBz4PB/bLuFVWof7IM6jmzRu70txBTdTFheVujfZ2WJ5ta82iF8E8/KFo4w7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.929.0/index.min.mjs": "sha384-s/OXGBz4PB/bLuFVWof7IM6jmzRu70txBTdTFheVujfZ2WJ5ta82iF8E8/KFo4w7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.929.0/LICENSE
```

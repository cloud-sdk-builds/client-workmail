...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DBKrcHrd3s34pFjeSo0EBqXl7khQmgb+YsU9uPeW6lzEsejwZ/oR6BIFmt/dxp8h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.185.0/index.min.mjs": "sha384-DBKrcHrd3s34pFjeSo0EBqXl7khQmgb+YsU9uPeW6lzEsejwZ/oR6BIFmt/dxp8h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.185.0/LICENSE
```

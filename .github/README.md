...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GZzclJoqOHs0GgACsTL8Wi/+C0thh8KWRU7Oqh4o+I38d1LoUxX9lwLn9PUSkxPg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.272.0/index.min.mjs": "sha384-GZzclJoqOHs0GgACsTL8Wi/+C0thh8KWRU7Oqh4o+I38d1LoUxX9lwLn9PUSkxPg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.272.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.54.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.54.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zglZw+/1tmRwVP0mIJvrTwrBpmNt4mn+eW9bgMkZLW4xJZSSQK4LbgNNDIoa3VoX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.54.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.54.0/index.min.mjs": "sha384-zglZw+/1tmRwVP0mIJvrTwrBpmNt4mn+eW9bgMkZLW4xJZSSQK4LbgNNDIoa3VoX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.54.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.502.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.502.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7Y2e9r8ARwhwVLnoB82juh/XYP9gbyb7sgPsUqjSDF9E1ODjFlnEAU5LTYpsSjC2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.502.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.502.0/index.min.mjs": "sha384-7Y2e9r8ARwhwVLnoB82juh/XYP9gbyb7sgPsUqjSDF9E1ODjFlnEAU5LTYpsSjC2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.502.0/LICENSE
```

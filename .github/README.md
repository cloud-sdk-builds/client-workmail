...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eFQabKFtJvfB3LI6xBGmzX4DlINtUIRldhaJFz9smwxk9gsVqmipL6YWcmK65rNL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.461.0/index.min.mjs": "sha384-eFQabKFtJvfB3LI6xBGmzX4DlINtUIRldhaJFz9smwxk9gsVqmipL6YWcmK65rNL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.461.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wdev+L7uWKk1IThWBHsr5bUIpuclzA24ruS+JPBn98ckLZtXb7EzfpevbfgW8d1E
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.235.0/index.min.mjs": "sha384-wdev+L7uWKk1IThWBHsr5bUIpuclzA24ruS+JPBn98ckLZtXb7EzfpevbfgW8d1E"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.235.0/LICENSE
```

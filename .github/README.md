...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.6.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.6.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-box2K+mvmrIQ6bDOfNCsHmwKa9LdG3VG4hkLeLOdrAcW9IicwR+LQ1XxW0iV7yYq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.6.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.6.0/index.min.mjs": "sha384-box2K+mvmrIQ6bDOfNCsHmwKa9LdG3VG4hkLeLOdrAcW9IicwR+LQ1XxW0iV7yYq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.6.0/LICENSE
```

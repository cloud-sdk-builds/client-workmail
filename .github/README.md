...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vyksAtKLx2GISnbxCRktd4x9OzCD/GNNXQV51ucS2GK+mBuHNaMhONJucuuzeEBL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.509.0/index.min.mjs": "sha384-vyksAtKLx2GISnbxCRktd4x9OzCD/GNNXQV51ucS2GK+mBuHNaMhONJucuuzeEBL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.509.0/LICENSE
```

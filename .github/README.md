...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aF9B9N3cssdVdrgCsbLLbrTQku1bjdmAbIf1FYV3dFuG9iu5aR0HSU3//V/EnLMk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.713.0/index.min.mjs": "sha384-aF9B9N3cssdVdrgCsbLLbrTQku1bjdmAbIf1FYV3dFuG9iu5aR0HSU3//V/EnLMk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.713.0/LICENSE
```

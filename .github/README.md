...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.1017.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1017.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ezq7mcSPlWejppvcN8TlH9fjByLSk+qzbGKSZr62YQ/kptszbaUG6rprxNDt4exn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1017.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.1017.0/index.min.mjs": "sha384-Ezq7mcSPlWejppvcN8TlH9fjByLSk+qzbGKSZr62YQ/kptszbaUG6rprxNDt4exn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.1017.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.7.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.7.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F7/DlKvcLrUEaSA/1VQDyXuji13Xp9hJJx78rDZl7dZihf7zNZouAluI7zwQ6TH6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.7.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.7.0/index.min.mjs": "sha384-F7/DlKvcLrUEaSA/1VQDyXuji13Xp9hJJx78rDZl7dZihf7zNZouAluI7zwQ6TH6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.7.0/LICENSE
```

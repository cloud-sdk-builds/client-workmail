...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.306.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.306.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9qMHe4g0RwpBpKHJXLpZHFllKb2T8Ab9l1PpwHYv2qXQ699B82Y6GA8dQntKBTS3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.306.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.306.0/index.min.mjs": "sha384-9qMHe4g0RwpBpKHJXLpZHFllKb2T8Ab9l1PpwHYv2qXQ699B82Y6GA8dQntKBTS3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.306.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZPNTMzp+zNvhfvjOgN41eYcG3zO+G5y/C75/03aLZTgyb5WL6cxZfAxL4qgQgszD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.186.0/index.min.mjs": "sha384-ZPNTMzp+zNvhfvjOgN41eYcG3zO+G5y/C75/03aLZTgyb5WL6cxZfAxL4qgQgszD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.186.0/LICENSE
```

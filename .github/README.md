...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.341.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.341.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NMwcncH0OlBDL87Ugbpv4IMgcDulvKsKNV1La0qek6KUtdtl67NCgLtJ6nRHSdy1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.341.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.341.0/index.min.mjs": "sha384-NMwcncH0OlBDL87Ugbpv4IMgcDulvKsKNV1La0qek6KUtdtl67NCgLtJ6nRHSdy1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.341.0/LICENSE
```

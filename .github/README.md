...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5z/Sk/xHnHeLvCwoUlBLQi/Nh7KNTC1dpfFEgwb8VloRjHUZ8HG+xkxp7HkYXzPp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.552.0/index.min.mjs": "sha384-5z/Sk/xHnHeLvCwoUlBLQi/Nh7KNTC1dpfFEgwb8VloRjHUZ8HG+xkxp7HkYXzPp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.552.0/LICENSE
```

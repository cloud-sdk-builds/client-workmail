...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-i0JuPjlD2c5SAgyru8U+89PjShlW4cLXuvUoNSnfIG82ufF8szPdcBIh/mIe7jII
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.347.1/index.min.mjs": "sha384-i0JuPjlD2c5SAgyru8U+89PjShlW4cLXuvUoNSnfIG82ufF8szPdcBIh/mIe7jII"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.347.1/LICENSE
```

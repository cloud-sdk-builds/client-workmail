...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AVSzwqQLWOgOe41n34hb00DcgpFdyCs1un/jrPz6VrYQpylPbXr6kbHdSW4cyua+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.278.0/index.min.mjs": "sha384-AVSzwqQLWOgOe41n34hb00DcgpFdyCs1un/jrPz6VrYQpylPbXr6kbHdSW4cyua+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.278.0/LICENSE
```

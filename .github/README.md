...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s7AyYDB/qqK8bJHYtO7fgvANzYYFwEaKovG96B+PotharFicdiLIHF2OGk3hJn95
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.696.0/index.min.mjs": "sha384-s7AyYDB/qqK8bJHYtO7fgvANzYYFwEaKovG96B+PotharFicdiLIHF2OGk3hJn95"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.696.0/LICENSE
```

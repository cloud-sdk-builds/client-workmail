...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CUzR8L4QGsmc0EAmFL3/wz0K5wVHFTHh9jtHGB1j4hYbECgUDTIA0xLLhKqRd0BC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.159.0/index.min.mjs": "sha384-CUzR8L4QGsmc0EAmFL3/wz0K5wVHFTHh9jtHGB1j4hYbECgUDTIA0xLLhKqRd0BC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.159.0/LICENSE
```

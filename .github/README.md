...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.862.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.862.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EVx+S7uQ/4hWrAF6rsqFE0Gwq/KIQrXf1fFdMvjt+ryUsrvDzudDO5W2rfP8JOHa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.862.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.862.0/index.min.mjs": "sha384-EVx+S7uQ/4hWrAF6rsqFE0Gwq/KIQrXf1fFdMvjt+ryUsrvDzudDO5W2rfP8JOHa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.862.0/LICENSE
```

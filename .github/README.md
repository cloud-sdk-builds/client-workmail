...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m0aUnq6rjGMm5RH8SXLLoQ9BMkzd9cShUeD2f10DYxIw8Hn+qk+KJI3ostDTNs4x
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.798.0/index.min.mjs": "sha384-m0aUnq6rjGMm5RH8SXLLoQ9BMkzd9cShUeD2f10DYxIw8Hn+qk+KJI3ostDTNs4x"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.798.0/LICENSE
```

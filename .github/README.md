...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.9.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.9.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eMjt7xeLmI7UaLLVxj+bf0DIuWsFWSv95AKy4bSYJDxXxGY95BlIFEV/tR3Vn5ie
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.9.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.9.0/index.min.mjs": "sha384-eMjt7xeLmI7UaLLVxj+bf0DIuWsFWSv95AKy4bSYJDxXxGY95BlIFEV/tR3Vn5ie"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.9.0/LICENSE
```

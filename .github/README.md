...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.436.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.436.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hbcxTdiBcMQhePgXpHSvxW/p3Wiw+2AD9sfzpTOqewk5NCd1AZCTBO94+6aNMdFe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.436.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.436.0/index.min.mjs": "sha384-hbcxTdiBcMQhePgXpHSvxW/p3Wiw+2AD9sfzpTOqewk5NCd1AZCTBO94+6aNMdFe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.436.0/LICENSE
```

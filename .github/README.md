...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qw66KlTVwBiHk1dxKh3Y65dYKNxAIlnKTvqPaa2AGojfa0Nkcvx+DNBYfc3Vk67O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.82.0/index.min.mjs": "sha384-qw66KlTVwBiHk1dxKh3Y65dYKNxAIlnKTvqPaa2AGojfa0Nkcvx+DNBYfc3Vk67O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.82.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.99.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.99.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Kx/rwDWBZQU+EePWW3x+ZdQU54xPL7ZZNmkxkxebYo2QvaBEFtyc7zKW3LcuQWB8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.99.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.99.0/index.min.mjs": "sha384-Kx/rwDWBZQU+EePWW3x+ZdQU54xPL7ZZNmkxkxebYo2QvaBEFtyc7zKW3LcuQWB8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.99.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f6e2PszPaU0/KpVvMST74SZrxWXFXWt/iJWCD6LiE+w5A9+Ec+oY0vE7o21UIuFL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.998.0/index.min.mjs": "sha384-f6e2PszPaU0/KpVvMST74SZrxWXFXWt/iJWCD6LiE+w5A9+Ec+oY0vE7o21UIuFL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.998.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X93/i2QNFTLbfpKo5ruXKZAIIW+S+0HrKYWa0Y9/Vwz4DvXiHPQs6dFHPkAnjnTi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.535.0/index.min.mjs": "sha384-X93/i2QNFTLbfpKo5ruXKZAIIW+S+0HrKYWa0Y9/Vwz4DvXiHPQs6dFHPkAnjnTi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.535.0/LICENSE
```

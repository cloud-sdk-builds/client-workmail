...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.669.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.669.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L64VivqBsKqkQ+XY9J5XZRay68Dbrd9DZKs5sxd5vHnCC2QpCwyRnJgBDkERAsS/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.669.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.669.0/index.min.mjs": "sha384-L64VivqBsKqkQ+XY9J5XZRay68Dbrd9DZKs5sxd5vHnCC2QpCwyRnJgBDkERAsS/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.669.0/LICENSE
```

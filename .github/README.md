...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xgy8KHqfzaPKcgyn/tChDoy+m+dbRA/FVMSBvgA+EQW3rFcBmq66bnw3tqw7jIbn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.224.0/index.min.mjs": "sha384-Xgy8KHqfzaPKcgyn/tChDoy+m+dbRA/FVMSBvgA+EQW3rFcBmq66bnw3tqw7jIbn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.224.0/LICENSE
```

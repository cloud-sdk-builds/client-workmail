...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.208.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.208.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-32FpMtVw9Sg8jsKJHMPedr+sptutD9lA5lD3AfOZGuXPbBi6SvKx83eqSuxH8WGo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.208.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.208.0/index.min.mjs": "sha384-32FpMtVw9Sg8jsKJHMPedr+sptutD9lA5lD3AfOZGuXPbBi6SvKx83eqSuxH8WGo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.208.0/LICENSE
```

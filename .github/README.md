...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5i8ML4kNwU2qoVsesP18aL13zcwwbf8utOvmJv2OVjYmEs/Rxo9dixHEU1bo9R0e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.261.0/index.min.mjs": "sha384-5i8ML4kNwU2qoVsesP18aL13zcwwbf8utOvmJv2OVjYmEs/Rxo9dixHEU1bo9R0e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.261.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CvZIXGMZXl38sAVTSLGOPD02hLBrdBO5Hmq13gJeCnKhed3eUe1OpEUxy7MEVoqk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.972.0/index.min.mjs": "sha384-CvZIXGMZXl38sAVTSLGOPD02hLBrdBO5Hmq13gJeCnKhed3eUe1OpEUxy7MEVoqk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.972.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WQJOV5KrwlI4sZFMCLt3XsNbIX/9t9aBuBqXl13jqHdYE7m7ruBdN1sbJcb9FehE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.67.0/index.min.mjs": "sha384-WQJOV5KrwlI4sZFMCLt3XsNbIX/9t9aBuBqXl13jqHdYE7m7ruBdN1sbJcb9FehE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.67.0/LICENSE
```

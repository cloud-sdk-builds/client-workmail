...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.13.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.13.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-AsHRp/EtGlkRDMkJrZurI/IOZgXNufeGiSi7vTx3rXcMd7Aln6nHOirswv9Pp/Wu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.13.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.13.1/index.min.mjs": "sha384-AsHRp/EtGlkRDMkJrZurI/IOZgXNufeGiSi7vTx3rXcMd7Aln6nHOirswv9Pp/Wu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.13.1/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.678.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.678.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JKtlP5m+XJ3HRl8cAgrq8WlTZhqbAhgGR6hSVzY+ty1DG7rl61/KCR47ce05svJh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.678.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.678.0/index.min.mjs": "sha384-JKtlP5m+XJ3HRl8cAgrq8WlTZhqbAhgGR6hSVzY+ty1DG7rl61/KCR47ce05svJh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.678.0/LICENSE
```

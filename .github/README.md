...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p1RQ6H/vJbOdnR98XBqxytV0ZP8+Sn+rxYugLtbUPVaIsyooaW+P6Q+mZ1aC9nrS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.664.0/index.min.mjs": "sha384-p1RQ6H/vJbOdnR98XBqxytV0ZP8+Sn+rxYugLtbUPVaIsyooaW+P6Q+mZ1aC9nrS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.664.0/LICENSE
```

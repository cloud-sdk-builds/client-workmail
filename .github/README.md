...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m+K78qZira1YkF0XWBl1KGXs9YXSBTiidUURGGFsrelMOq2/wksglvVk/Ja5a2Dn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.290.0/index.min.mjs": "sha384-m+K78qZira1YkF0XWBl1KGXs9YXSBTiidUURGGFsrelMOq2/wksglvVk/Ja5a2Dn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.290.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xHXkuWXqe1PROK/XYy3DJRwSPhcNm2q0v4z6iLlny84Tb3Klgqmt1LIO3zXAmiRf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.988.0/index.min.mjs": "sha384-xHXkuWXqe1PROK/XYy3DJRwSPhcNm2q0v4z6iLlny84Tb3Klgqmt1LIO3zXAmiRf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.988.0/LICENSE
```

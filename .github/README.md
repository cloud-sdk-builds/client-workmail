...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.14.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.14.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O6WqHheaP7WXH7jpVx5thFg+NHHeR67wJh6iDqpfK5uoypXZmyCnZuHhmcVzx+gx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.14.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.14.0/index.min.mjs": "sha384-O6WqHheaP7WXH7jpVx5thFg+NHHeR67wJh6iDqpfK5uoypXZmyCnZuHhmcVzx+gx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.14.0/LICENSE
```

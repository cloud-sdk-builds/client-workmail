...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n4or53vLjnBRcmW839fb106chvWIpR4s8nuJKWurZ0RU1OmnRegeqZ5LmHz9HxKO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.525.0/index.min.mjs": "sha384-n4or53vLjnBRcmW839fb106chvWIpR4s8nuJKWurZ0RU1OmnRegeqZ5LmHz9HxKO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.525.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.87.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.87.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DQzPC6Rk0L7vS6rkHbyxpBlumR6m+2UWobw6zIscqDkbc1OoLTERQZun5BD1Kqrx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.87.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.87.0/index.min.mjs": "sha384-DQzPC6Rk0L7vS6rkHbyxpBlumR6m+2UWobw6zIscqDkbc1OoLTERQZun5BD1Kqrx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.87.0/LICENSE
```

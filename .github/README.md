...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.974.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.974.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ywnvMOlpE9QRu2R5a+zooVS0DG2A5wN8e0t6nNHrg5hyV1OR/2k5zsLooBiWvBv3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.974.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.974.0/index.min.mjs": "sha384-ywnvMOlpE9QRu2R5a+zooVS0DG2A5wN8e0t6nNHrg5hyV1OR/2k5zsLooBiWvBv3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.974.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PEDeMEmF9PPl8t9/EsOvPx0Mkg5hMSmVzUakK91h4UXN6TRboF5jIQQ1fAy76gKi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.985.0/index.min.mjs": "sha384-PEDeMEmF9PPl8t9/EsOvPx0Mkg5hMSmVzUakK91h4UXN6TRboF5jIQQ1fAy76gKi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.985.0/LICENSE
```

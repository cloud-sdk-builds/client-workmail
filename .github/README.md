...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-mjvzA6TqZTjfNg7vZPG1HR7psNx/lM/vqEpk2Gi6UdXqsohyK0t/74Z+3epRvP/R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.266.1/index.min.mjs": "sha384-mjvzA6TqZTjfNg7vZPG1HR7psNx/lM/vqEpk2Gi6UdXqsohyK0t/74Z+3epRvP/R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.266.1/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.683.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.683.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+xAcQyxO02Gg3e/cS3aLKH0baVL7jnlDJAAW4L+J9b1SinTwrF7RFDVwz0aJagKh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.683.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.683.0/index.min.mjs": "sha384-+xAcQyxO02Gg3e/cS3aLKH0baVL7jnlDJAAW4L+J9b1SinTwrF7RFDVwz0aJagKh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.683.0/LICENSE
```

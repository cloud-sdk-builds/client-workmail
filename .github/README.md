...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.190.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.190.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k9lRgw7Nlo4EW7FRLvXqipI4X4z8IZtjQ7f/Y98iH9411Wmz0IafAYGIdm8JjTBp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.190.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.190.0/index.min.mjs": "sha384-k9lRgw7Nlo4EW7FRLvXqipI4X4z8IZtjQ7f/Y98iH9411Wmz0IafAYGIdm8JjTBp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.190.0/LICENSE
```

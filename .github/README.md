...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YOvCkxLIS7zHZkgLAbKNDLrweNx6hQ774wovd0fikcdPiasG+8OHY4bVRI8biZUX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.620.0/index.min.mjs": "sha384-YOvCkxLIS7zHZkgLAbKNDLrweNx6hQ774wovd0fikcdPiasG+8OHY4bVRI8biZUX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.620.0/LICENSE
```

...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+XSK6I/fpFBqCwT1E9TyMggnm7FB5enDvb5vatfxlbdv+Ef7e4NWmoWyQNdymXt9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.983.0/index.min.mjs": "sha384-+XSK6I/fpFBqCwT1E9TyMggnm7FB5enDvb5vatfxlbdv+Ef7e4NWmoWyQNdymXt9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.983.0/LICENSE
```

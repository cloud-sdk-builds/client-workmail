...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8EC/fUUmicNBp7kyHEjuvNXYYjmsXVeI0BWyR02R7Kf2Fy/99LJnneR6cgYfAndq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.423.0/index.min.mjs": "sha384-8EC/fUUmicNBp7kyHEjuvNXYYjmsXVeI0BWyR02R7Kf2Fy/99LJnneR6cgYfAndq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.423.0/LICENSE
```

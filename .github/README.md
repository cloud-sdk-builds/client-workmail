...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-sRbyI5krIyMnm0HLyF63/9BJcL80GdfO0PCKdjVIcdFolr6erzBZu0XtQpGK7waP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.726.1/index.min.mjs": "sha384-sRbyI5krIyMnm0HLyF63/9BJcL80GdfO0PCKdjVIcdFolr6erzBZu0XtQpGK7waP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.726.1/LICENSE
```

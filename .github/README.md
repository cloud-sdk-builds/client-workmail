...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.39.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.39.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+KlunLoGvNGFUC+KtqWxvPrLbSvrdZ1YbY4l2kPOq5GtxFRsp4pcmMsw/vCetqyc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.39.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.39.0/index.min.mjs": "sha384-+KlunLoGvNGFUC+KtqWxvPrLbSvrdZ1YbY4l2kPOq5GtxFRsp4pcmMsw/vCetqyc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.39.0/LICENSE
```

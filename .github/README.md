...
[`@aws-sdk/client-workmail`](https://www.npmjs.com/package/@aws-sdk/client-workmail/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QQYmZW5Ydr/Wr5Jd+ucenKdfk3Qdb0fBHFRZ/xlBRlObPDq0PMFaQpxtRzQji41V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workmail": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workmail@3.259.0/index.min.mjs": "sha384-QQYmZW5Ydr/Wr5Jd+ucenKdfk3Qdb0fBHFRZ/xlBRlObPDq0PMFaQpxtRzQji41V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workmail/blob/refs/tags/3.259.0/LICENSE
```
